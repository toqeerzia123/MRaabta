<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="PettyCash_ReceiptEdit.aspx.cs" Inherits="MRaabta.Files.PettyCash_ReceiptEdit" %>
        ...
        <table class="input-form" style="width: 95%;">
            <tr>
                ...
                <td class="input-field">
                    <asp:TextBox ID="txt_frmdate" runat="server" CssClass="med-field" MaxLength="10" onkeypress="return false;"
                ...
                <td class="input-field">
                    <asp:TextBox ID="txt_todate" runat="server" CssClass="med-field" MaxLength="10" Width="190" onkeypress="return false;"></asp:TextBox>
            ...
            <asp:GridView ID="GridView" runat="server" AutoGenerateColumns="false" CssClass="mGrid"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="date" DataField="date" ItemStyle-HorizontalAlign="left"
                        ItemStyle-Width="20%"></asp:BoundField>
                    <asp:BoundField HeaderText="Cash Type" DataField="cash_type" ItemStyle-HorizontalAlign="left"
                        ItemStyle-Width="20%"></asp:BoundField>
                    <asp:BoundField HeaderText="Checque Number" DataField="chque_no" ItemStyle-HorizontalAlign="left"
                        ItemStyle-Width="20%"></asp:BoundField>
