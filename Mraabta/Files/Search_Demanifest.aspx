<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="Search_Demanifest.aspx.cs" Inherits="MRaabta.Files.Search_Demanifest" %>
    ...
    <table>
        <tr>
            ...
            <td style="float: left; text-align: center; width: 200px;">
                <asp:Button ID="btn_search" runat="server" Text="Search Demanifest" 
