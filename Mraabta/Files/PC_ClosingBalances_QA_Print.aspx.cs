    ...
    public partial class PC_ClosingBalances_QA_Print : System.Web.UI.Page
    {
        ...
        protected void rp_data_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                HyperLink branchnameHbl = e.Item.FindControl("hl_BranchName_Hbl") as HyperLink;

                if (branchname.Text.ToString().Equals("HEAD OFFICE") || branchname.Text.ToString().Equals("GAWADAR MAIN OFFICE"))
                {
                }
                else
                {
                    branchname.NavigateUrl = "Feeding_Status.aspx?date=" + hf_from.Value.ToString() + "&branchname=" + branchname.Text.ToString() + "";
                    branchnameHbl.NavigateUrl = "Feeding_Status_HBL.aspx?date=" + hf_from.Value.ToString() + "&branchname=" + branchname.Text.ToString() + "";
                }
            }
        }
    }
