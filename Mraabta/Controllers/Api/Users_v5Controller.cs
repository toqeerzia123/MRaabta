...
namespace MRaabta.Controllers.Api
{
    ...
    public class Users_v5Controller : ApiController
    {

        AccountDB_v5 accdb_ = new AccountDB_v5();
        ...
        public userDetailResponse_v5 Login(string riderCode, string password, string imei1 = null, string imei2 = null, string simSno = null)
        {
            int userID, createdBy, RoleId;
            DateTime createdOn = new DateTime();
            string RiderCode, branchCode, username, message = "";
            bool isSuccess = false;
            var userDetailResponse_ = new userDetailResponse_v5();
            try
            {
                Accounts_v5 acc_ = new Accounts_v5();
                if (riderCode == null || password == null)
                {
                    userDetailResponse_ = new userDetailResponse_v5
                    {
                        isSuccess = false,
                        message = "Kindly send both username and password, empty string not allowed.",
                        accountObj = null,
                ...
                if (dt_.Rows.Count > 0)
                {
                    acc_ = new Accounts_v5
                    {
                        ...
                        RoleId = Convert.ToInt32(dt_.Rows[0]["roleID"]),
                        Status = 1,
                        Longitude= Convert.ToDecimal(dt_.Rows[0]["Longitude"]),
                        Latitude= Convert.ToDecimal(dt_.Rows[0]["Latitude"])
                        ///////////////////////////
                    };
                    userDetailResponse_ = new userDetailResponse_v5
                    {
            ...
            {
                userDetailResponse_ = new Models.Api.userDetailResponse_v5
                {
                    isSuccess = false,
