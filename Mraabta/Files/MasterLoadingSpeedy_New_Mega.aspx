<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.master" CodeBehind="MasterLoadingSpeedy_New_Mega.aspx.cs" Inherits="MRaabta.Files.MasterLoadingSpeedy_New_Mega" %>
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            function PopulateBranches() {
                var dropdown = document.getElementById('branches');
                $.ajax({
                    url: 'MasterLoadingSpeedy_New_Mega.aspx/GetBranchesForDropDown',
                    type: 'POST',
        ...
        <script type="text/javascript">
            function RouteChange(dd) {
                ...
                $.ajax({
                    url: 'MasterLoadingSpeedy_New_Mega.aspx/RouteChange',
                    type: 'POST',
                    contentType: 'application/json; charset=utf-8',
                    datatype: 'json',
        ...
        <script type="text/javascript">
            ...
            function AddBag_(Bag) {
                ...
                var saved = false;
                $.ajax({
                    url: 'MasterLoadingSpeedy_New_Mega.aspx/InsertBag',
                    type: 'POST',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    ...
                    success: function (result) {
                        ...
                        if (resp.Status.toString() == "0") {
                            ...
                            window.location.href = "MasterLoadingSpeedy_New_Mega.aspx";
                            txt_bagno.disabled = false;
                            return;
                        }
                        else {
                ...
                if (r1 == "1") {
                    ...
                    var newTr = bags.insertRow(1);  //document.createElement('tr'); 
        ...
        <script type="text/javascript">
            function RemoveRow(btn) {
                ...
                if (LoadingID.trim() != "") {
                    ...
                    $.ajax({
                        url: 'MasterLoadingSpeedy_New_Mega.aspx/RemoveRow',
                        type: 'POST',
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'json',
        ...
        <script type="text/javascript">
            function CalculateItems() {
                ...
                totalCount.innerText = 'Total Scanned Items: ' + ((bags.rows.length) - 2).toString();
        ...
        <script type="text/javascript">
            function SaveLoading() {
                ...
                $.ajax({
                    ...
                    url: 'MasterLoadingSpeedy_New_Mega.aspx/InsertLoading',
                    type: 'POST',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    data: JSON.stringify(jsonObj),
                    success: function (resp_) {
                        ...
                        if (resp[0] == "1") {
                            ...
                            ResetAll();
                            window.open('MasterLoadingSpeedy_New_Mega.aspx', '_self');
                        }
                        else {
        ...
        <script type="text/javascript">
            function VidChange(txt) {
                ...
                $.ajax({
                    url: 'MasterLoadingSpeedy_New_Mega.aspx/GetLoadingData',
                    type: 'POST',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    data: "{'vid':'" + vid + "'}",
