<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="MasterArrival.aspx.cs" Inherits="MRaabta.Files.MasterArrival" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('input[name=type]').click(function () {
                ...
                if (val == '1') {
                    $('.recoverySpan').css('display', 'none');
                } else {
                    $('.recoverySpan').css('display', 'block');
                }
            });
        });
    ...
    <script type="text/javascript">
        ...
        function GetArrivalDetails(txt) {
            ...
            $.ajax({
                ...
                url: 'MasterArrival.aspx/GetArrivalDetails',
                type: 'POST',
    ...
    <script type="text/javascript">
        function AddConsignment() {
            ...
            var conType = document.getElementById('<%= dd_contype.ClientID %>');
            var cn = document.getElementById('txt_consignment');
            var wtt = cn.value.trim();
            var consignments = document.getElementById('tbl_details');
            var CNWt = cn.value.trim();
            if (CNWt.toString().includes('|')) {
                wtt = CNWt.split('|')[1];
                var recoverycn = document.getElementById('recoverycn').value;
                if (recoverycn.length > 0) {
                    cn.value = recoverycn;
                    document.getElementById('recoverycn').value = '';
                } else {
                    cn.value = CNWt.split('|')[2];
                }
            }
            cn.disabled = true;
            ...
            function onSuccess(result) {
                ...
                if (result.toString() == "N/A") {
                    ...
                    var oldweight = document.createElement('input');
                    oldweight.type = 'hidden';
                    oldweight.value = '0.5';
                    ...
                    col = newTr.insertCell(5);
                    newTr.cells[5].innerText = "";
                    newTr.cells[4].appendChild(oldweight);
                    newTr.cells[4].appendChild(txtWeight);
                    newTr.cells[4].childNodes[0].onchange = CalculateTotalWeight.bind(newTr.cells[0].childNodes[0]);
                    newTr.cells[5].appendChild(txtPieces);
                    newTr.cells[5].childNodes[0].onchange = validate.bind(newTr.cells[0].childNodes[0]);
                    ...
                    col = newTr.insertCell(9); // Old Weight Column
                    newTr.cells[9].innerText = oldweight.value;
                    ...
                    var oldweight = document.createElement('input');
                    oldweight.type = 'hidden';
                    oldweight.value = result[0][2].toString();
    ...
    <script type="text/javascript">
        function SaveArrival() {
                ...
                consignment =
                    {
                        ...
                        OldWeight: tr.cells[4].childNodes[0].value.toString(),
                        Weight: tr.cells[4].childNodes[1].value.toString(),
            ...
            $.ajax({
                ...
                url: 'MasterArrival.aspx/InsertArrival',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                ...
                success: function (result) {
                    ...
                    if (errorFound) {
                        ...
                        window.open('Arrival_print_speedy.aspx?XCode=' + resp[0][2].toString() + '&pg=qaszdfg', '_blank');
                        riderCode.focus();
                        riderCode.value = '';
                        ResetAll();
                    }
            ...
            <ContentTemplate>
                <table class="input-form" style="width: 90%">
                    ...
                    <tr>
                        ...
                        <td class="space"></td>
                        <td class="field">
                            <span class="recoverySpan">Recovery Consignment No:</span>
                        </td>
                        <td class="input-field">
                            <span class="recoverySpan input-field">
                                <input type="text" id="recoverycn" style="width:230px !important"/></span>
                        </td>
                    </tr>
                    <tr>
        ...
        <div style="width: 100%; overflow: scroll; height: 250px;">
            ...
            <table id="tbl_details" class="tblDetails">
                <tr class="headerRow">
                    ...
                    <td style="width: 5%;">Booking Weight
                    </td>
                </tr>
            </table>
        </div>
