<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master"
    CodeBehind="StockHOConsumption_IMS.aspx.cs" Inherits="MRaabta.Files.StockHOConsumption_IMS" %>
...
<asp:Content ID="form1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table cellpadding="0" cellspacing="0" width='100%' class='mGrid_Table'>
        <tr>
            <td colspan="12" align="center" class="head_column">
                <h3 style="text-align: center">Stock Consumption (HO Departments)</h3>
            </td>
        </tr>
    </table>
    ...
    <script type="text/javascript">
        ...
        var GetTypeProducts = () => {
            ...
            $.ajax({
                type: "POST",
                url: 'StockHOConsumption_IMS.aspx/GetTypeProducts',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    TypeProducts = rs.d;
        ...
        var GetDepartments = () => {
            ...
            $.ajax({
                type: "POST",
                url: 'StockHOConsumption_IMS.aspx/GetDepartments',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    console.log(rs);
        ...
        var GetFilteredStockZone = (StartDate, EndDate) => {
            $.ajax({
                type: 'post',
                url: 'StockHOConsumption_IMS.aspx/GetFilteredStockZone',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var getProductsModal = (Id) => {
            $.ajax({
                type: "POST",
                url: 'StockHOConsumption_IMS.aspx/GetProductsSingle',
                contentType: "application/json; charset=utf-8",
        ...
        var getRecordDetails = (Id) => {
            $.ajax({
                type: 'post',
                url: 'StockHOConsumption_IMS.aspx/GetFilteredStockZonePer',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ Id: Id }),
                success: (rs) => {
        ...
        var ModifyRequest = (data) => {
            $.ajax({
                type: 'post',
                url: 'StockHOConsumption_IMS.aspx/ModifyRequest',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var save = (data) => {
            $.ajax({
                type: "POST",
                url: 'StockHOConsumption_IMS.aspx/SaveStockDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ model: data }),
                success: (rs) => {
        ...
        var GetBranchStock = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockHOConsumption_IMS.aspx/GetBranchStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var GetHOStock = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockHOConsumption_IMS.aspx/GetHOStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
