...
{
    public partial class COD_ReversePickupCODPortalReport : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (Year_check.Rows.Count > 0)
                {
                    ...
                    Response.AddHeader("content-disposition",
                     "attachment;filename=COD_ReversePickupCODPortalReport.csv");
                    Response.Charset = "";
        ...
        public static string Search_CSV_Click(string DateStart, string DateEnd, string Zone, string Account, string Status, string OutputType)
        {
            try
            {
                ...
                string redirectUrl = "COD_ReversePickupCODPortalReport.aspx?xy=" + encryp;
                return redirectUrl;
            }
            catch (Exception er)
            {
                return "COD_ReversePickupCODPortalReport.aspx";
            }
        }
            ...
            try
            {
                ...
                for (int j = 0; j < ds.Rows.Count; j++)
                {
                    ...
                    list.Add(new CODPickupResponse
                    {
                        ...
                        consigneePhoneNo = ds.Rows[j]["consigneePhoneNo"].ToString(),
