<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="Recovery_Letter_Print.aspx.cs" Inherits="MRaabta.Files.Recovery_Letter_Print" %>
    ...
    <fieldset>
        ...
        <table style="font-family: Calibri; font-size: medium; padding-bottom: 0px !important; padding-top: 0px !important"
            ...
            <tr>
                ...
                <td class="field" style="width: 15%;">group Id
                </td>
        ...
        <div style="width: 100%; height: 250px; overflow: scroll;">
            <span id="Table_1" class="tbl-large">
                ...
                <asp:UpdatePanel ID="up_1" runat="server" OnDataBinding="up_1_DataBinding">
                    <ContentTemplate>
                        <span id="Table_1" class="tbl-large">
                            <asp:GridView ID="gv_tariff" runat="server" AlternatingRowStyle-CssClass="alt" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Customer Group Name/ Customer Name">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Letter Type">
                                        <ItemTemplate>
                                            <asp:Label ID="txt_Lettertypet" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Lettertype") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Days">
                                        <ItemTemplate>
                                            <asp:Label ID="txt_Days" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Days") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Letter Ref No">
                                        <ItemTemplate>
                                            <asp:Label ID="txt_LetterRefno" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Letter_RefNo") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Remarks">
                                        <ItemTemplate>
                                            <asp:Label ID="txt_Remarks" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Remarks") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Ref">
                                        <ItemTemplate>
                                            <asp:Label ID="txt_Ref" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Ref_Letter") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Account No">
                                        <ItemTemplate>
                                            <asp:Label ID="txt_Account" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Accountno") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hy_1" runat="server" Text="View" Target="_blank"></asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
