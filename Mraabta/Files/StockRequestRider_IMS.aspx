<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="StockRequestRider_IMS.aspx.cs" Inherits="MRaabta.Files.StockRequestRider_IMS" %>
    ...
    <script type="text/javascript">
        var getRider = () => {
            $.ajax({
                ...
                type: "POST",
                url: 'StockRequestRider_IMS.aspx/GetRider',
        ...
        var GetFilteredStockZone = (StartDate, EndDate) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockRequestRider_IMS.aspx/GetFilteredStockZone',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var getRecordDetails = (Id, name) => {
            $.ajax({
                type: 'post',
                url: 'StockRequestRider_IMS.aspx/GetFilteredStockZonePer',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ Id: Id }),
                success: (rs) => {
        ...
        var save = (model) => {
            $.ajax({
                type: "POST",
                url: 'StockRequestRider_IMS.aspx/SaveStockDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var GetHOStock = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockRequestRider_IMS.aspx/GetHOStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var GetZoneStock = (zone) => {
            $.ajax({
                type: 'post',
                url: 'StockRequestRider_IMS.aspx/GetZoneStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
