...
{
    public partial class PettyCash_CIHReport : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "view")
            {
                ...
                ScriptManager.RegisterStartupScript(Page, typeof(Page), "OpenWindow", "window.open('PettyCash_cihprintall.aspx?ID=" + id + "&company=" + dd_company.SelectedValue.ToString() + "');", true);
            }
        }
        protected void btn_view_print_all_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(id))
            {
                ...
                string script = String.Format(script_, "PettyCash_cihprintall.aspx?ID=" + id + "&company=" + dd_company.SelectedValue.ToString() + "", "_blank", "");
