<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.master" CodeBehind="Manage_ConsignmentApproval_QA.aspx.cs" Inherits="MRaabta.Files.Manage_ConsignmentApproval_QA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:HiddenField ID="hd_ShipperAddress" runat="server" />
    <asp:HiddenField ID="hd_PakageContents" runat="server" />
    ...
    <table cellpadding="0" cellspacing="0" width='100%' class='mGrid_Table'>
        <tr>
            <td colspan="12" align="center" class="head_column">
                <h3>Manage Consignment Approval</h3>
            </td>
        </tr>
    </table>
    <table style="font-family: Calibri; font-size: medium; padding-bottom: 0px !important; padding-top: 0px !important; width: 97%"
        ...
        <tr style="margin: 20px 0px 0px !important; padding: 10px 0px 0px 0px !important;">
            ...
            <td class="input-field" style="width: 15% !important;">
                <telerik:RadTextBox ID="txt_cnNumber" runat="server" Skin="Web20" MaxLength="15"
                    ...
                    Resize="None" resolvedrendermode="Classic" Width="160px" oninput="process(this)"  OnTextChanged="txt_cnNumber_TextChanged">
                </telerik:RadTextBox>
        ...
        <tr>
            <td class="field" style="width: 15% !important; text-align: right !important; padding-right: 5px;"
                id="div1" runat="server">Payment Mode
            </td>
            <td class="input-field" style="width: 13% !important;" id="div2" runat="server">
            ...
            <td class="space" style="width: 2% !important; margin: 0px 0px 0px 0px !important;"></td>
            <td class="field" style="width: 15% !important; text-align: right !important; padding-right: 5px;"
                id="div3" runat="server">Payment Transaction ID
            </td>
            <td class="input-field" style="width: 13% !important;" id="div4" runat="server">
                <asp:TextBox ID="txt_TransactionID" value="0" Enabled="false" runat="server" Width="100px"
                    onkeypress="return isNumberKey(event);"></asp:TextBox>
            </td>
            <td class="space" style="width: 10% !important; margin: 0px 0px 0px 0px !important;"></td>
            <td class="field" style="width: 10% !important; text-align: right !important; padding-right: 5px;">Weight
            </td>
            <td class="input-field" style="width: 12% !important;">
        ...
        <tr style="margin: 0px 0px 0px 0px !important;">
            <td class="field" style="width: 15% !important; text-align: right !important; padding-right: 5px;">Consignee Address
            </td>
            ...
            <td class="input-field" style="width: 12% !important;">
                <asp:TextBox ID="txt_pieces" runat="server" Enabled="true" onkeypress="return isNumberKey(event);"
                    onchange="VolumeChange()" Width="40%" AutoPostBack="false"></asp:TextBox>
            </td>
            <td class="space" style="width: 10% !important; margin: 0px 0px 0px 0px !important;"></td>
        </tr>
        <tr style="margin: 0px 0px 0px 0px !important;">
    ...
    <table style="font-family: Calibri; font-size: medium; padding-bottom: 0px !important; padding-top: 0px !important; width: 97%"
        ...
        <tr style="margin: 20px 0px 0px !important; padding: 10px 0px 0px 0px !important;">
            ...
            <td class="field" style="width: 15% !important; font-weight: normal !important; padding-right: 5px;">
                ...
                <div>
                    <asp:TextBox ID="txt_PiecesModifiere" runat="server" Enabled="false"></asp:TextBox>
                </div>
            </td>
            <td class="field" style="width: 15% !important; font-weight: normal !important; padding-right: 5px;">
                <div style="display: inline; text-align: left; width: 100%">
                    ...
                    <span id="Span1" class="tbl-large" style="width: 100%;">
                        ...
                        <asp:GridView ID="gv_CNModifiers" runat="server" AutoGenerateColumns="false" CssClass="mGrid"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Name" DataField="priceModifierName" HeaderStyle-Width="10%" />
                                <asp:TemplateField HeaderText="Pieces" HeaderStyle-Width="5%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txt_modifier_pieces" Style="overflow: hidden;" onkeypress="return isNumberKeydouble();"
                                            runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ModifierPieces") %>'
                                            Enabled="false"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Modifier Value" HeaderStyle-Width="5%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txt_modifiedCalculationValue" Style="overflow: hidden;" onkeypress="return isNumberKey(event);"
                                            runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ModifiedCalculatedValue") %>'
                                            Enabled="false"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Value" HeaderStyle-Width="5%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txt_gValue" Style="overflow: hidden;" onkeypress="return isNumberKey(event);"
                                            runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "calculatedValue") %>'
                                ...
                                <asp:BoundField HeaderText="Calculation Base" DataField="calculationBase" HeaderStyle-Width="5%" />
                                <asp:BoundField HeaderText="Taxable" DataField="isTaxable" HeaderStyle-Width="5%" />
                                <asp:BoundField HeaderText="Description" DataField="description" HeaderStyle-Width="5%" />
                                <asp:TemplateField HeaderText="DeclaredValue" HeaderStyle-Width="5%">
                                    <ItemTemplate>
    ...
    <asp:HiddenField ID="hd_misroute" runat="server" />
