...
{
    public partial class Rider_ECUpdate : System.Web.UI.Page
    {
        ...
        private int updatedRider(string riderCode, string Branch)
        {
            ...
            {
                query = "Update  Riders set zoneId = '" + ddl_zoneId.SelectedValue.ToString() + "'  \n" +
                "  , expressCenterId = '" + ddl_expressCenterId.SelectedValue.ToString() + "' ,branchId = '" + ddl_branch.SelectedValue.ToString() + "'  where   riderCode = '" + riderCode + "' and  branchID = '" + Branch + "'";
