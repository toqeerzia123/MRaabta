<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="BranchConsumption_IMS.aspx.cs"
    Inherits="MRaabta.Files.BranchConsumption_IMS" %>
    ...
    <table cellpadding="0" cellspacing="0" width='100%' class='mGrid_Table'>
        <tr>
            <td colspan="12" align="center" class="head_column">
                <h3 style="text-align: center">Stock Consumption (Branch)</h3>
            </td>
        </tr>
    </table>
            ...
            <div class="FilterArea">
                <%--<div>
                    <table cellpadding="0" cellspacing="0" width='100%' class='mGrid_Table'>
                        <tr>
                            <td colspan="12" align="center" class="head_column">
                                <h3 style="text-align: center; font-size: 16px;" class="ml-2">Request Modification </h3>
                            </td>
                        </tr>
                    </table>
                    <div class="row ml-2">
                    ...
                    <td>
                        <nav>
                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-zone-tab" data-toggle="tab" href="#nav-zone" role="tab" aria-controls="nav-zone" aria-selected="false" style="font-size: 14px;">Branch Consumption</a>
    ...
    <script type="text/javascript">
        ...
        $(function () {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm == true) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: 'BranchConsumption_IMS.aspx/DeleteStockRequest',
            ...
            $('#btnSave').click(function () {
                ...
                for (let x of rows) {
                    var row = $(x);
                    var locationId = parseInt(row.find('td:eq(0)').find('select').val());
                    debugger
            ...
            $('body').on('focusout', '.txtoracle', function () {
                ...
                $.ajax({
                    type: 'post',
                    url: 'StockInventory.aspx/GetStockItems',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
        ...
        var getLocations = () => {
            ...
            $.ajax({
                type: "POST",
                url: 'BranchConsumption_IMS.aspx/GetLocations',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    Locations = rs.d;
        ...
        var GetFilteredStockZone = (StartDate, EndDate) => {
            $.ajax({
                type: 'post',
                url: 'BranchConsumption_IMS.aspx/GetFilteredStockZone',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var getRecordDetails = (Id) => {
            $.ajax({
                type: 'post',
                url: 'BranchConsumption_IMS.aspx/GetFilteredStockZonePer',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ Id: Id }),
                success: (rs) => {
                    ...
                    for (let z of data) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: 'BranchConsumption_IMS.aspx/GetProductsSingle',
                            contentType: "application/json; charset=utf-8",
        ...
        var ModifyRequest = (data) => {
            $.ajax({
                type: 'post',
                url: 'BranchConsumption_IMS.aspx/ModifyRequest',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var save = (data) => {
            $.ajax({
                type: "POST",
                url: 'BranchConsumption_IMS.aspx/SaveStockDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ model: data }),
                success: (rs) => {
        ...
        var GetBranchStock = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'BranchConsumption_IMS.aspx/GetBranchStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var GetBranchConsume = () => {
            $.ajax({
                type: 'post',
                url: 'BranchConsumption_IMS.aspx/GetBranchConsumption',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getPendingReqDetails = (Id) => {
            $.ajax({
                type: 'post',
                url: 'BranchConsumption.aspx/GetPendingRequestDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ Id: Id }),
                success: (rs) => {
        ...
        var addRow = () => {
            ...
            for (let z of Locations) {
                locations += `<option value="${z.Value}">${z.Text}</option>`;
            }
            ...
            var html = `<tr>
                            <td style="font-size:12px;">
                                <select class="form-control locationId" style="font-size:12px;">
                                ${locations}
                                </select>
                            </td>
                           <td>
                            ...
                            <td style="font-size:12px;">
                                <input maxlength="6" autopostback="true" id="txtqty"  onkeypress="return isNumberKey(event)" type="text" class="form-control" style="font-size:12px;" />
                            </td>
                            <td>
                                <input class="form-control txtunit" disabled="disabled" type="text" id="unit" style="width:4em; font-size:12px;"/>
                            </td>
