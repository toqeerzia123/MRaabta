<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="PettyCash_GLReport_hoa.aspx.cs" Inherits="MRaabta.Files.PettyCash_GLReport_hoa" %>
        ...
        <table class="input-form" style="width: 95%;">
            ...
            <tr>
                ...
                <td class="input-field">
                    ...
                    <asp:ListBox SelectionMode="Multiple" ID="dd_branch" runat="server" AutoPostBack="true"
                        CssClass=" dropdown width" OnSelectedIndexChanged="dd_branch_SelectedIndexChanged"
                        Width="200" Rows="4"></asp:ListBox>
                </td>
                <td class="field" style="width: 13%">
                </td>
                <td class="field">
                ...
                <td class="input-field">
                    <asp:ListBox SelectionMode="Multiple" ID="dd_ec" runat="server" CssClass=" dropdown width"
                        Width="200" Rows="4"></asp:ListBox>
                </td>
            </tr>
              <tr>
                ...
                <td class="input-field">
                    <asp:DropDownList ID="dd_eh" runat="server" Width="200px" CssClass="dropdown width"
                ...
                <td class="input-field">
                    <asp:DropDownList ID="dd_sh" runat="server" Width="200px" CssClass="dropdown width">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
