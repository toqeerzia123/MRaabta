<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="StockIssuanceAccount_IMS.aspx.cs" Inherits="MRaabta.Files.StockIssuanceAccount_IMS" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1" runat="server" class="mt-5">
            ...
            <table cellpadding="0" cellspacing="0" width='100%' class='mGrid_Table '>
                <tr>
                    <td colspan="12" align="center" class="head_column">
                        <h3 style="text-align: center">Stocks Issuance To Account
                        </h3>
                    </td>
            ...
            <div class="shadow rounded">
                <div class="">
                    ...
                    <div class="row ml-2 mt-2">
                        <div class="col-md-5">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-form-label mt-1" style="font-size: 12px;">Account No</label>
                                <input type="text" name="StartDate" id="inputState" class="ddlRider form-control" style="font-size: 12px;" />
                ...
                <table id="ReqGrid" class="MainTbl table table-striped">
                    <thead class="">
                        <tr style="font-size: 12px;">
                            <th style="width: 30%; text-align: center;">Account</th>
    ...
    <script type="text/javascript">
        ...
        var getRiders = () => {
            ...
            $.ajax({
                type: "POST",
                url: 'StockIssuanceAccount_IMS.aspx/GetAccount',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var kk = '';
                    kk += `<option value="0">Select Account</option>`;
                    var rr = rs.d;
                    for (let y of rr) {
        ...
        var getRequests = (id, startdate, enddate) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuanceAccount_IMS.aspx/GetRequests',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false, 
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm == true) {
                        $.ajax({
                            type: "POST",
                            url: 'StockIssuanceAccount_IMS.aspx/DeleteStockRequest',
                            contentType: "application/json; charset=utf-8",
        ...
        var getMyStock = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuanceAccount_IMS.aspx/GetMyStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getZoneStock = (zone) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuanceAccount_IMS.aspx/GetZoneStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var getRequestDetails = (id, isupdated, rider, name) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuanceAccount_IMS.aspx/GetRequestsDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
...
<br/>
        ...
        var save = (data) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuanceAccount_IMS.aspx/SaveIssuanceDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        $(function () {
            ...
            $('#btnFilter').on('click', function () { 
                var id = document.getElementById('inputState').value
