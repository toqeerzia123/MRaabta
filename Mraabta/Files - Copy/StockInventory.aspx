<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="StockInventory.aspx.cs" Inherits="MRaabta.Files.StockInventory" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('body').on('change', '.typeId', function () {
                ...
                //$(this).parent().parent().find('td:eq(4)').find('.txtbarcodefrom').attr('data-prefix', prefix);
                //$(this).parent().parent().find('td:eq(4)').find('.txtbarcodefrom').val(prefix);
            ...
            $('body').on('blur', '#QtyModal', function (e) {
                ...
                //var barcodefrom = parseInt($('#barcodeToModal').val());
            ...
            $('body').on('blur', '.txtissueqty', function () {
                ...
                //    parseInt($(this).parent().parent().find('td:eq(3)').find('input[type=text]').val(""));
                ...
                //var ProductToCheck = $(this).parent().parent().find('td:eq(5)').find('#productChangeId').val();
                //selectorProd[selectorProd.selectedIndex].value
                var ProductToCheck = parseInt($(this).parent().parent().find('td:eq(2)').find('select').val());
                var barcodeto = 0;
                if (ProductToCheck == 17) {
                    barcodefrom = barcodefrom.toString().slice(0, -1);
            ...
            $('#btnSave').click(function () {
                ...
                for (let x of rows) {
                    ...
                    //for (var i = 0 in data.StockRequestDetails) {
                    //    if (barcodeFrm <= y.data.BarcodeFrm && barcodeto >= y.data.BarcodeTo) {
                    //        alert('please check barcode to field');
                    //        return;
                    //    }
                    //}
