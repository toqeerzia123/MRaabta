<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="StockIssuanceRider.aspx.cs" Inherits="MRaabta.Files.StockIssuanceRider" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1" runat="server" class="mt-5">
                        ...
                        <tr>
                            ...
                            <div class="row ml-2 mt-2">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label mt-1" style="font-size: 12px;">Rider</label>
                                    <div class="col-sm-6">
                    ...
                    <table id="ReqGrid" class="MainTbl table table-striped">
                        <thead class="">
                            <tr style="font-size: 12px;">
                                <th style="width: 20%; text-align: center;">Rider</th>
    ...
    <script>
        ...
        var getRiders = () => {
            ...
            $.ajax({
                type: "POST",
                url: 'StockIssuanceRider.aspx/GetRider',
        ...
        var getRequests = (id) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuanceRider.aspx/GetRequests',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
                //processData: false,
        ...
        var getMyStock = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuanceRider.aspx/GetMyStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getZoneStock = (zone) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuanceRider.aspx/GetZoneStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var getRequestDetails = (id, isupdated, rider, name) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuanceRider.aspx/GetRequestsDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ id: id }),
                success: (rs) => {
        ...
        var save = (data) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuanceRider.aspx/SaveIssuanceDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        $(function () {
            ...
            $('body').on('change', '.ddlRider', function () {
                ...
                //$(this).parent().parent().find('td:eq(1)').find('.productChangeId').html(id);
            });
            ...
            $('body').on('click', '#btnSubmit', function () {
                ...
                //var rider = parseInt($(this).data('zone'));
