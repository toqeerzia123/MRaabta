<%@ Page Language="C#" AutoEventWireup="true" Title="Discount Booking Screen" EnableEventValidation="False" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="DiscountBookingEC.aspx.cs" Inherits="MRaabta.Files.DiscountBookingEC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function PaymentModeChange() {
            ...
            if (val_ == "6") {
                document.getElementById('<%= txt_TransactionID.ClientID %>').maxLength = "14";
    ...
    <table width="100%">
        <tr>
            <td colspan="12" align="center" class="head_column">
                <h3><asp:Label ID="lbl_ScreenName" runat="server"></asp:Label></h3>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td rowspan="12" style="width: 30%; vertical-align: top;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="cb_ServiceType" runat="server" AppendDataBoundItems="true" AutoPostBack="true"
                                    Width="90%" onchange="weightChange()" OnSelectedIndexChanged="cb_ServiceType_SelectedIndexChanged1">
            ...
            <td rowspan="9" style="width: 20%; vertical-align: top;">
                ...
                <fieldset id="div_discountcn" runat="server">
                    ...
                    <asp:Button ID="btn_discount_save" runat="server" Text="Apply Discount" CssClass="button"
                        UseSubmitBehavior="false" Visible="false" OnClick="btn_Discount_Save_Click">
                    </asp:Button>
                </fieldset>
            </td>
        </tr>
            ...
            <tr>
                ...
                <td align="center" style="width: 150px;">
                    <asp:Button ID="rd_AddPriceModifier" runat="server" Text="Add" autopostback="true"
                        OnClick="rd_AddPriceModifier_Click" CausesValidation="false" UseSubmitBehavior="false">
                    </asp:Button>
                </td>
            </tr>
            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_PricemodifierPieces" runat="server" onkeypress="return isNumberKey(event);"
                                        onkeyup="calc()" Text='<%# DataBinder.Eval(Container.DataItem, "Pieces")%>' Style="width: 55%;
                                        text-align: center;" OnTextChanged="PricemodifierPieces_TextChanged" AutoPostBack="true"></asp:TextBox>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_Value" runat="server" onkeypress="return isNumberKey(event);"
                                        Text='<%# DataBinder.Eval(Container.DataItem, "CalculatedValue")%>' Style="width: 55%;
