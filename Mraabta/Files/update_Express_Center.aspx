<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="update_Express_Center.aspx.cs" Inherits="MRaabta.Files.update_Express_Center" %>
    ...
    <fieldset>
        ...
        <table style="font-size: medium; padding-bottom: 0px; width: 100%;">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txt_Eccode" runat="server" MaxLength="13" Width="160px"> </asp:TextBox>
                </td>
                ...
                <td>
                    <asp:Button ID="btn_Get" runat="server" Text="Get" CssClass="button" UseSubmitBehavior="false"
