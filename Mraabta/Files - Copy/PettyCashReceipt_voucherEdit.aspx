<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="PettyCashReceipt_voucherEdit.aspx.cs" Inherits="MRaabta.Files.PettyCashReceipt_voucherEdit" %>
    ...
    <div>
        ...
        <table class="input-form" style="width: 95%;">
            <tr>
                ...
                <td class="input-field">
                    <asp:DropDownList ID="dd_company" runat="server" Enabled="false" Width="180px" CssClass="dropdown width">
                       <%-- <asp:ListItem Text="M&P" Value="1"></asp:ListItem>
                        <asp:ListItem Text="R&R" Value="2"></asp:ListItem>--%>
                    </asp:DropDownList>
                </td>
                <td class="space">
                </td>
        ...
        <table class="input-form" style="width: 95%;">
               <tr >
                ...
                <td class="input-field">
                    <asp:TextBox ID="txt_date" runat="server" CssClass="med-field" MaxLength="10"  Width="180px"></asp:TextBox>
            ...
            <tr>
                <td colspan="4">
                    <asp:Button ID="btn_add" runat="server" Text="SAVE" Width="130" CssClass="button1"
                        ...
                        <asp:Button ID="btn_back" runat="server" Text="BACK" Width="130" 
                        CssClass="button1" onclick="btn_back_Click"
                        />
