<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="Manage_ConsignmentApproval_Import.aspx.cs" Inherits="MRaabta.Files.Manage_ConsignmentApproval_Import" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        ...
        function Calculate_GridSum() {

            var grid = document.getElementById("<%=gv_CNModifiers.ClientID%>");
            var sum = 0;
    ...
    <table style="font-family: Calibri; font-size: medium; padding-bottom: 0px !important;
        ...
        <tr style="float: none !important;">
            <td colspan="9" style="float: none !important; font-variant: small-caps !important;
        ...
        <tr style="margin: 20px 0px 0px !important; padding: 10px 0px 0px 0px !important;">
            ...
            <td class="input-field" style="width: 15% !important; float: left;">
                <asp:CheckBox ID="chk_bulkUpdate" runat="server" Text="Bulk Update" AutoPostBack="true"
                    OnCheckedChanged="chk_bulkUpdate_CheckedChanged" Width="80%" Visible="false" />
            </td>
            ...
            <td class="field" style="width: 10% !important; text-align: right !important; padding-right: 5px;">
            </td>
        </tr>
        <tr style="margin: 20px 0px 0px !important; padding: 10px 0px 0px 0px !important;">
            <td class="field" style="width: 15% !important; text-align: right !important; padding-right: 5px;">
        ...
        <tr style="margin: 0px 0px 0px 0px !important;">
            ...
            <td class="input-field" style="width: 15% !important;">
                <asp:DropDownList ID="Or_Country" runat="server" Width="100%" AppendDataBoundItems="true"
                    onchange="ChangeMaxLength(this);">
        ...
        <tr>
            <td colspan="9" style="float: none !important; font-variant: small-caps !important;
                ...
                <b>
                    <asp:CheckBox ID="cb_checkbox" runat="server" AutoPostBack="true" Text="Feed COD Details"
                        OnCheckedChanged="cb_checkbox_CheckedChanged" /></b>
            </td>
        </tr>
    </table>
    <asp:Panel ID="codTable" runat="server" Visible="false">
        <table style="font-family: Calibri; font-size: medium; padding-bottom: 0px !important;
            padding-top: 0px !important; width: 97%" class="input-form">
            <tr style="float: none !important;">
                <td colspan="9" style="float: none !important; font-variant: small-caps !important;
            ...
            <tr style="margin: 20px 0px 0px !important; padding: 10px 0px 0px 0px !important;">
                ...
                <td class="input-field" style="width: 15% !important;">
                    <asp:TextBox ID="txt_descriptionCOD" runat="server" Enabled="false" Text="Import Shipment"></asp:TextBox>
                </td>
                <td class="space" style="width: 2% !important; margin: 0px 0px 0px 0px !important;">
                </td>
                <td class="field" style="width: 15% !important; text-align: right !important; padding-right: 5px;">
                ...
                <td class="input-field" style="width: 15% !important; vertical-align: middle !important;">
                    <asp:TextBox ID="txt_codAmount" Enabled="false" Text="0" runat="server" onkeypress="return isNumberKey(event);"></asp:TextBox>
                </td>
                <td class="space" style="width: 1% !important; margin: 0px 0px 0px 0px !important;">
                </td>
                <td class="field" style="width: 15% !important; text-align: right !important; padding-right: 5px;">
            ...
            <tr style="margin: 20px 0px 0px !important; padding: 10px 0px 0px 0px !important;">
                ...
                <td class="field" style="width: 20% !important; font-weight: normal !important; padding-right: 5px;">
                    <div style="display: inline; text-align: left; width: 100%">
                        <b>Declared Value(Insurance)</b></div>
                    <div>
                        ...
                        <span id="Span1" class="tbl-large" style="width: 100%;">
                            ...
                            <asp:GridView ID="gv_CNModifiers" runat="server" AutoGenerateColumns="false" CssClass="mGrid"
                                ...
                                <Columns>
                                    ...
                                    <%--                <asp:TemplateField HeaderText="Value">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txt_gstValue" Style="overflow: hidden;" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "calculatedValue") %>'
                                                Enabled="true"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>
