<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.master" CodeBehind="Runsheet_Speedy_2.aspx.cs" Inherits="MRaabta.Files.Runsheet_Speedy_2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ResetAll() {
            window.location.href = "Runsheet_Speedy_2.aspx";
        }
    </script>
    ...
    <script type="text/javascript">
        function RiderChange(cnt) {
            ...
            //    for (var i = 0; i < ddl_riders.options.length; i++) {
            //        var currentRider = ddl_riders.options[i].value;
            //        if (currentRider == cnt.options[cnt.options.selectedIndex].value) {
            //            ddl_riders.options[i].selected = true;
            //            txt_riderno.value = cnt.options[cnt.options.selectedIndex].value;
            //            routeFound = true;
            //            break;
            //        }
            //        count++
            ...
            //}
            //else if (cnt.tagName.toString().toUpperCase() == "INPUT") {
            //    if (cnt.value == "") {
            //        alert("Kindly Select Rider");
            //        focusWorking(cnt);
            //        cnt.value = '';
    ...
    <%--////////////////////////////ROUTE Change///////////////////////////////////////////////////////////////Shaheer/////////////////////--%>
        function RouteChange(cnt) {
            ...
            if (routeFound) {
                $.ajax({
                    url: 'Runsheet_Speedy_2.aspx/GetRider',
                    type: 'POST',
    ...
    <script type="text/javascript">
        function ConsignmentChange(txt_consignment) {
            ...
            //   RiderChange(txtRider);
            //   RouteChange(txt_routeCode);
            ...
            $.ajax({
                async: false,
                type: 'post',
                url: 'Runsheet_Speedy_2.aspx/CheckCODControls',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ cn: txt_consignment.value }),
                success: (result) => {
            ...
            //if (txt_consignment.value.charAt(0) == "5") {
            //    if (txt_consignment.value.toString().length != "15") {
            //        CODControlCheck = false;
            ...
            if (rn.trim() == "") {
                alert('Kindly Save Runsheet First');
            ...
            $.ajax({
                url: 'Runsheet_Speedy_2.aspx/GetConsignmentDetail',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                datatype: 'json',
    ...
    <script type="text/javascript">
        function SaveRunsheet() {
            try {
                ...
                if (save) {
                    $.ajax({
                        url: 'Runsheet_Speedy_2.aspx/SaveRunsheet',
                        //url: 'http://localhost/MR/api/SaveRunsheetApi/Save',
                        type: 'POST',
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'json',
                        ...
                        success: function (result) {
                            ...
                            if (resp[0] == "0" || resp[0] == "2") {
                                ...
                                window.open('Runsheet_Speedy_2.aspx', '_parent');
                            }
                        },
                        error: function (xhr, status, error) {

                            alert('Error in Generating Runsheet' + error);
                            loader.style.display = 'none';
                            document.getElementById('save_r').disabled = false;
                            return;
                        },
                        failure: function (xhr, status, error) {
                            alert('Failed to Generate Runsheet' + error);
                            loader.style.display = 'none';
                            document.getElementById('save_r').disabled = false;
                            return;
                        }
                    ...
                    //var obj = Head;
                    //obj.Details = jsonObject.Details;
                    //$.ajax({
                    //    //url: 'Runsheet_Speedy_2.aspx/SaveRunsheet',
                    //    url: 'http://localhost/MR/api/SaveRunsheetApi/Save',
                    //    type: 'POST',
                    ...
                    //        if (rs.sts == 1) {
                    //            loader.style.display = 'none';
                    //            alert('Runsheet Saved. Runsheet Number: ' + rs.msg);
                    //            window.open('RunsheetInvoice_Plain.aspx?Xcode=' + rs.msg + '&RCode=' + routeCode, '_blank');
                    //            window.open('Runsheet_Speedy_2.aspx', '_parent');
                    //        }
                    //        else {
                    //            alert(rs.msg);
...
<%--        window.onload = OnWindowLoad;
        ...
        function PopulateBranches() {
            var dropdown = document.getElementById('branches');
            $.ajax({
                url: 'Runsheet_Speedy_2.aspx/GetBranchesForDropDown',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                datatype: 'json',
                data: '',
    ...
    <table style="font-family: Calibri; font-size: medium; padding-bottom: 0px !important; padding-top: 0px !important"
        ...
        <tr>
            ...
            <td class="input-field" style="width: 15% !important;">
                <%--<asp:TextBox ID="txt_runsheetNumber" runat="server" Enabled="false"></asp:TextBox>--%>
        ...
        <tr>
            ...
            <td class="input-field" style="width: 15% !important;">
                ...
                <%--      <asp:TextBox ID="txt_user" runat="server" Enabled="false"></asp:TextBox>--%>
            </td>
        ...
        <tr>
            ...
            <td class="input-field" style="width: 15% !important;">
                ...
                <%--   <asp:TextBox ID="txt_branchCode" runat="server" Enabled="false"></asp:TextBox>--%>
            </td>
            <td class="space" style="margin: 0px 0px 0px 0px !important; width: 5% !important;"></td>
            ...
            <td class="input-field" style="width: 15% !important;">
                ...
                <%--<asp:TextBox ID="txt_zoneCode" runat="server" Enabled="false"></asp:TextBox>--%>
            </td>
        </tr>
        <tr>
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td style="width: 20%; padding-right: 60px;">
                    <asp:TextBox ID="txt_consignment" runat="server" onkeypress="return isNumberKey(event);"
                        MaxLength="20" onchange="ConsignmentChange(this);"></asp:TextBox>
