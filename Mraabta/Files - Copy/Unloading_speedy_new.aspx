<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="Unloading_speedy_new.aspx.cs" Inherits="MRaabta.Files.Unloading_speedy_new" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function RemoveBag(obj) {
            ...
            $.ajax({
                url: 'Unloading_speedy_new.aspx/RemoveBag',
                type: 'POST',
        ...
        function RemoveCN(obj) {
            ...
            $.ajax({
                url: 'Unloading_speedy_new.aspx/RemoveCN',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                data: Code,
    ...
    <script language="javascript" type="text/javascript">
        ...
        function SaveUnloading_BAG(tr, mode) {
            ...
            $.ajax({
                ...
                url: 'Unloading_speedy_new.aspx/save_BAG',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
        ...
        function SaveUnloading_CN(tr, mode) {
            ...
            $.ajax({
                ...
                url: 'Unloading_speedy_new.aspx/save_CN',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                data: JSON.stringify(jsonObj),
        ...
        function checkValidations(txt) {
            ...
            $.ajax({
                async: false,
                type: 'post',
                url: 'Unloading_speedy_new.aspx/CheckControls',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function chkManChanged() {
            ...
            for (var i = 1; i < tbl_bagnew.rows.length; i++) {
                ...
                var descStatus = 'EXCESS RECEIVED';
                //alert(txt_BagNo +"   "+ row.cells[12].getElementsByTagName("hidden").value);
                if (row.cells[12].getElementsByTagName("hidden").value != "undefined") {

                    descStatus = row.cells[12].getElementsByTagName("hidden");
                } 
                var txt_BagNo = row.cells[1].innerText;
                rowCount = i;
                if (txt_BagNo == bag.trim()) {
                    //alert('Inside');
                    if (hd_NewBag.value == '0' && row.cells[2].innerText == 'SHORT RECEIVED') {
                        chk[0].checked = true;
        ...
        function SaveChangedValues() {
            ...
            if ((jsonObj.Bags.length > 0 || jsonObj.Consignments.length > 0) && unloadingID != "0") {
                $.ajax({
                    url: 'Unloading_speedy_new.aspx/SaveChangedValues',
                    type: 'POST',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    data: JSON.stringify(jsonObj),
        ...
        function getUnloadingData() {
            ...
            $.ajax({
                url: 'Unloading_speedy_new.aspx/GetBagNo',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                data: Code,
        ...
        function OnSuccess(response) {
            ...
            if (count - 1 > 0) {
                for (var i = 0; i < count - 1; i++) {
                    ...
                    //hd_descStatus.value = dt.Table1[i][10];
        ...
        function getdt(response) {
            ...
            if ((count - 1) > 0) {
                for (var i = 0; i < count - 1; i++) {
                    ...
                    ///////////Description	//////////////
                    col = newTr.insertCell(2);
                    newTr.cells[2].innerText = dt.Table1[i][10];
                    ///////////Origin////////////////////
                    col = newTr.insertCell(3);
        ...
        function getDTC(response) {
            ...
            $.ajax({
                url: 'Unloading_speedy_new.aspx/Cities',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                datatype: 'json',
                data: '',
                success: function (result) {
                    ...
                    if (count - 1 > 0) {
                        for (var i = 0; i < count - 1; i++) {
                            ...
                            hd_descStatus.value = dt.Table1[i][11];
                            hd_descStatus.style.textAlign = 'center';
        ...
        function chkManChanged_CN() {
            ...
            for (var i = 1; i < tbl_cns.rows.length; i++) {
                ...
                if (consignmentno == txt_consignmentno) {
                    if (hd_NewCN.value == '0' && row.cells[2].innerText == 'SHORT RECEIVED') {
                        chk[0].checked = true;
                        row.cells[2].innerText = 'RECEIVED';
        ...
        function getData_Consignment() {
            ...
            $.ajax({
                url: 'Unloading_speedy_new.aspx/GetCNNo',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                data: Code,
    ...
    <script type="text/javascript">
        ...
        function btn_okDialogue_Click() {
            ...
            $.ajax({
                url: 'Unloading_speedy_new.aspx/SaveChangedValues_saveButton',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                data: JSON.stringify(jsonObj),
