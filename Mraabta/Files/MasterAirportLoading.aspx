<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="MasterAirportLoading.aspx.cs" Inherits="MRaabta.Files.MasterAirportLoading" %>
...
.ajax__scroll_none {
            ...
            <div>
                <Ajax1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="300px"
                    ...
                    <Ajax1:TabPanel ID="TabPanel2" runat="server" HeaderText="Consignments" Visible="false">
                        <ContentTemplate>
                            <table style="width: 100% !important;">
                                <tr>
        ...
        <script type="text/javascript">
            ...
            function PopulateBranches() {
                var dropdown = document.getElementById('branches');
                $.ajax({
                    url: 'MasterAirportLoading.aspx/GetBranchesForDropDown',
                    type: 'POST',
        ...
        <script type="text/javascript">
            function RouteChange(dd) {
                ...
                $.ajax({
                    url: 'MasterAirportLoading.aspx/RouteChange',
                    type: 'POST',
                    contentType: 'application/json; charset=utf-8',
                    datatype: 'json',
        ...
        <script type="text/javascript">
            ...
            function AddBag_(Bagging) {
                ...
                if (bags.rows.length > 0) {
                    ...
                    $.ajax({
                        url: 'MasterAirportLoading.aspx/InsertBag',
                        type: 'POST',
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'json',
                        ...
                        success: function (result) {
                            ...
                            if (resp.Status.toString() == "0") {
                                ...
                                window.location.href = "MasterAirportLoading.aspx";
                                return;
                            }
                            else {
                ...
                if (r1 == "1") {
                    ...
                    dd_dest.className = 'dropdown Route';
                    dd_dest.onchange = CalculateTotalWeight.bind(newTr.cells[4].childNodes[0]);
                    dd_dest.style.display = "";
                    dd_dest.backgroundColor = "red";
                    ...
                    dd_dest.onchange = CalculateTotalWeight1.bind(newTr.cells[3].childNodes[0]);
            ...
            <%--    var cnNo = document.getElementById('<%= txt_consignmentno.ClientID %>');--%>
                ...
                if (r1 == "1") {
                    ...
                    var txt_hiddenfield2 = document.createElement('input');
                    txt_hiddenfield2.type = 'label';
                    txt_hiddenfield2.className = 'textBox';
                    txt_hiddenfield2.value = 'Valid';
                    txt_hiddenfield2.style.width = '90%';
                    txt_hiddenfield2.style.textAlign = 'center';
                    ...
                    newTr.cells[8].style.textAlign = "center";
                    newTr.cells[8].appendChild(txt_hiddenfield2);
            ...
            function AddBagEdit(SingleBag, AddMode) {
                ...
                var dd_dest = GetBranchDropDown_(Br, "dd_dest"); /*--122*/

                debugger;
                console.log(dd_dest.value);
                dd_dest.style.width = '90%'
                dd_dest.className = 'dropdown Route';
                dd_dest.style.display = "";
                //dd_dest.css('backgroundColor', 'red');
                //dd_dest.disabled = true;
                //getColor(dd_dest);
                ...
                for (var i = 0; i < newTr.cells[2].childNodes[0].options.length; i++) {
                    ...
                    if (dd_destValue == currentDestination) {
                        ...
                        newTr.cells[2].childNodes[0].dispatchEvent(event);
                        break;
                    }
                }
                ...
                debugger;
                getColor(newTr.cells[3].childNodes[0]);
                col = newTr.insertCell(4);
                newTr.cells[4].appendChild(txtWeight);
        ...
        <script type="text/javascript">
            ...
            var getColor = (el) => {
                var route = document.getElementById('<%= dd_route.ClientID %>');
                //el.parentElement.childNodes[0].css('backgroundColor', 'red');
                var iid = "";
                debugger;
                try {
                    iid = el.value;
                ...
                $.ajax({
                    type: 'POST',
                    url: 'MasterAirportLoading.aspx/GetData',
                    data: JSON.stringify({ id: iid, route: route.value }),
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
            ...
            function AddConsignment() {
                ...
                if (consignments.rows.length > 0) {
                    ...
                    var saved = false;
                    $.ajax({
                        url: 'MasterAirportLoading.aspx/InsertConsignment',
                        type: 'POST',
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'json',
                        data: JSON.stringify(jsonObj),
            ...
            function AddConsignment_(consignmentno) {
                ...
                if (r1 == "1") {
                    ...
                    txtremarks.style.textAlign = 'center';
                    debugger;
                    var dd_dest = GetBranchDropDown_(Br, "dd_dest");    /*--erty*/
                    dd_dest.style.width = '90%'
                    dd_dest.className = 'dropdown Route';
                    dd_dest.style.display = "";
                    //dd_dest.disabled = true;
            ...
            var cnNo = document.getElementById('<%= txt_bagno.ClientID %>');
                ...
                txt_hiddenfield.style.textAlign = 'center';
                debugger;
                var dd_dest = GetBranchDropDown_(Br, "dd_dest");        /*--wertyuikjnhb*/
                dd_dest.style.width = '90%'
                dd_dest.className = 'dropdown Route';
                dd_dest.style.display = "";
                //dd_dest.disabled = true;
        ...
        <script type="text/javascript">
            function RemoveRow(btn) {
                ...
                if (LoadingID.trim() != "") {
                    ...
                    $.ajax({
                        url: 'MasterAirportLoading.aspx/RemoveRow',
                        type: 'POST',
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'json',
            ...
            function CalculateTotalWeight() {
                ...
                for (var i = 1; i < bags.rows.length; i++) {
                    if (validNumber.test(bags.rows[i].cells[4].childNodes[0].value) && (bags.rows[i].cells[4].childNodes[0].value != "0")) {
                        ...
                        bags.rows[i].cells[3].childNodes[0].style.backgroundColor = "red";
                        chk = true;
                    }
                }
        ...
        <script type="text/javascript">
            function SaveLoading() {
                ...
                $.ajax({
                    ...
                    url: 'MasterAirportLoading.aspx/InsertLoading',
                    type: 'POST',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    data: JSON.stringify(jsonObj),
                    success: function (result) {
                        ...
                        if (resp[0] == "1") {
                            ...
                            ResetAll();
                            window.open('MasterAirportLoading.aspx', '_self');
                        }
                        else {
        ...
        <script type="text/javascript">
            function VidChange(txt) {
                ...
                $.ajax({
                    url: 'MasterAirportLoading.aspx/GetLoadingData',
                    type: 'POST',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
