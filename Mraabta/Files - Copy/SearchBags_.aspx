<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="SearchBags_.aspx.cs" Inherits="MRaabta.Files.SearchBags_" %>
    ...
    <div>
        ...
        <table class="input-form" style="width: 90%">
            ...
            <tr>
                ...
                <td class="space"></td>
                <td class="field" id="num" runat="server">Number:
                </td>
                <td>
                    ...
                    <asp:TemplateField ItemStyle-Width="5%" HeaderText="bag Number" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" CssClass="edit" runat="server" Target="_blank" Text='<%# DataBinder.Eval(Container.DataItem, "bagNumber")%>'
                                NavigateUrl='<%# "Bag_Print.aspx?Xcode=" + Eval("bagNumber")%>'></asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>
