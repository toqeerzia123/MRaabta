<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrackBag_New.aspx.cs" Inherits="MRaabta.Files.TrackBag_New" MasterPageFile="~/BtsMasterPage.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="font-family: Calibri; font-size: medium; padding-bottom: 0px !important; padding-top: 0px !important; width: 97%"
        ...
        <tr style="padding: 0px 0px 0px 0px !important;">
            <td colspan="10" style="padding-bottom: 1px !important; padding-top: 1px !important;">
                <h4 style="font-family: Calibri; margin: 0px !important;">Bag Info</h4>
            </td>
        </tr>
        <tr>
            <td class="field" style="width: 10% !important;"></td>
            <td class="input-field" style="width: 15%"></td>
            <td class="space" style="margin-right: 5% !important"></td>
            <td class="field" style="width: 10% !important;"></td>
            <td class="input-field" style="width: 15%"></td>
            <td class="space" style="margin-right: 5% !important"></td>
            <td class="field" style="width: 10% !important;"></td>
        ...
        <tr>
            <td class="field" style="width: 10% !important;">Bag No
        ...
        <tr>
            ...
            <td class="space" style="margin-right: 5% !important"></td>
            <td class="field" style="width: 10% !important;">Total Weight
            </td>
            <td class="input-field" style="width: 15%">
                <asp:TextBox ID="txt_totalWeight" runat="server" Width="100%"></asp:TextBox>
            </td>
            <td class="space" style="margin-right: 5% !important"></td>
            <td class="field" style="width: 10% !important;">Seal No
            </td>
            <td class="input-field" style="width: 15%">
        ...
        <tr>
            ...
            <td class="space" style="margin-right: 5% !important"></td>
            <td class="field" style="width: 10% !important;">Description
            </td>
    ...
    <table style="font-family: Calibri; font-size: medium; padding-bottom: 0px !important; padding-top: 0px !important; width: 97%"
        ...
        <tr style="padding: 0px 0px 0px 0px !important;">
            <td colspan="10" style="padding-bottom: 1px !important; padding-top: 1px !important;">
                <h4 style="font-family: Calibri; margin: 0px !important;">Tracking Details</h4>
            </td>
        </tr>
        <tr>
            <td class="field" style="width: 10% !important;">Arrived At
            </td>
            ...
            <td class="space" style="margin-right: 5% !important"></td>
            <td class="field" style="width: 10% !important;">Departure To
            </td>
            <td class="input-field" style="width: 15% !important;">
        ...
        <tr>
            <td class="field" style="width: 10% !important;">Status
            </td>
            <td class="input-field" style="width: 15% !important;">
    ...
    <Ajax1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="300px"
        ...
        <Ajax1:TabPanel runat="server" HeaderText="Manifest" ID="TabPanel1" Style="width: 100%; height: 100%; overflow-y: scroll !important">
            <HeaderTemplate>
                Manifests
            </HeaderTemplate>
            <ContentTemplate>
                <table style="width: 100% !important; height: 100% !important;">
                    <tr>
                        <td valign="top" style="width: 20%; font-weight: bold; margin-left: 20px;">Manifest Number
                        </td>
        ...
        <Ajax1:TabPanel ID="TabPanel2" runat="server" HeaderText="Consignments" Style="width:100%;height: 100%; overflow-y: scroll !important">
            <ContentTemplate>
                <table style="width: 100% !important; height: 100% !important;">
                    <tr>
                        <td valign="top" style="width: 20%; font-weight: bold; margin-left: 20px;">Consignment Number
                        </td>
                        <td valign="top" style="width: 80%">
