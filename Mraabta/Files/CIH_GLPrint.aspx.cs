...
{
    public partial class CIH_GLPrint : System.Web.UI.Page
    {
        double op_balance = 0;
        ...
        public void Data()
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                //  dt.Columns.Add("cnote", typeof(string));
        ...
        public DataSet GetData()
        {
            ...
            try
            {
                ...
                {
                    #region Commented
                    //            sqlString = "SELECT a.rank,CONVERT(varchar, a.date, 103) date,a.cashtype,a.debit dnote, a.credit  cnote,\n" +
                    //       "a.branch,company\n" +
                    //       " FROM\n" +
                    //       "(\n" +
                    //          "SELECT '1' RANK,\n" +
                    ...
                    //                       "   and pv.VoucherDate between '" + dt.ToString("yyyy-MM-dd") + "' and '" +  DateTime.ParseExact(hf_to.Value, "dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("yyyy-MM-dd") + "'\n" +
                    ...
                    //          "       AND pv.CreditClientId IS  NULL and  pv.ClientGroupId is not null\n" +
                    //          "       AND pv.paymentsourceid = '1'\n" +
                    //          "GROUP BY\n" +
                    //          "       VoucherDate,\n" +
                    //          "       pt.name,\n" +
                    ...
                    //           "   and pv.ChequeDate between '" + dt.ToString("yyyy-MM-dd") + "' and '" +  DateTime.ParseExact(hf_to.Value, "dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("yyyy-MM-dd") + "'\n" +
                    ...
                    //           "  and pv.[date] between '" + dt.ToString("yyyy-MM-dd") + "' and '" +  DateTime.ParseExact(hf_to.Value, "dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("yyyy-MM-dd") + "'\n" +
                    ...
                    //          "  and ch.t_date between '" + dt.ToString("yyyy-MM-dd") + "' and '" +  DateTime.ParseExact(hf_to.Value, "dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("yyyy-MM-dd") + "'\n" +
                    //          "  and ch.from_comp='" + hf_company.Value.ToString() + "'\n" +
                    //          " GROUP BY ch.t_date, b.[name],cm1.sdesc_OF\n" +
                    //          "\n" +
                    //          " union all\n" +
                    //          " --To Company\n" +
                    //          " SELECT '1' rank,SUM(ch.amount) debit,\n" +
                    //          "  0 credit,\n" +
                    ...
                    //          " GROUP BY ch.t_date, b.[name],cm.sdesc_OF" +
                    //          ") a\n" +
                    //          "ORDER BY 2,1"; 
                    #endregion
                ...
                else
                {
                  ...
                  "SELECT '2' rank,0 debit,\n" +
                  "  SUM(pv.Amount) credit,\n" +
                  "       'Deposit To Bank: ' + isnull(bo.bank_name,'')  cashtype,\n" +
                  "       pv.ChequeDate date,\n" +
                  "     b.[name] branch,  isnull( pv.DepositSlipNo,'')   DepositSlipNo,\n" +
                  "\t '' company\n" +
                  "  FROM deposit_to_bank pv\n" +
        ...
        public DataSet GetOpeningBalance()
        {
            ...
            try
            {
                ...
                if (hf_company.Value.ToString() == "1")
                {
                    ...
                    //      sqlString +=
                    //          " SELECT '1' rank,\n" +
                    //      "                       isnull(SUM(PV.Amount), 0) - SUM(ISNULL(mm.productAmount, 0))      debit,\n" +
                    //      "                             0 credit,\n" +
                    ...
                    //      "                          on b.branchCode = pv.BranchCode\n" +
                    //      "                       WHERE pv.BranchCode  IN (" + hf_branch.Value.ToString() + ")\n" +
                    //      "                         and pv.VoucherDate between  '" + startOfMonth.ToString("yyyy-MM-dd") + "' " +
                    //      " and  '" + dt.AddDays(-1).ToString("yyyy-MM-dd") + "' \n" +
                    //      "                            \n" +
                    //      "                         AND pv.CashPaymentSource IS NOT NULL\n" +
                    //      "                         AND (pv.PaymentSourceId IS NULL OR\n" +
                    //      "                             pv.PaymentSourceId = '1')\n" +
                    //      "                         AND pv.CashPaymentSource != '4'\n" +
                    //      "\n" +
                    //      "                      union all\n";
                    ...
                    //     "                          on b.branchCode = pv.BranchCode\n" +
                    //     "                       WHERE pv.BranchCode  IN (" + hf_branch.Value.ToString() + ")\n" +
                    //          //  "                         and pv.ChequeDate between '2018-" + dt.ToString("MM") + "-01' and\n" +
