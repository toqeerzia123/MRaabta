<%@ Page Title="Packing Material Rate List" Language="C#" MasterPageFile="~/BtsMasterPage.Master" AutoEventWireup="true" CodeBehind="PackingMaterialRateList.aspx.cs" Inherits="MRaabta.Files.PackingMaterialRateList" %>
    ...
    <ContentTemplate>
        <div class="row main-body newPanel">
            <fieldset class="fieldsetSmall">
               ...
               <legend style="font-size: medium;"><b>Packing Material Invoice List</b></legend>
