<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="StockRequestEC.aspx.cs" Inherits="MRaabta.Files.StockRequestEC" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1" runat="server" class="mt-5">
    ...
    <script type="text/javascript">
        ...
        var GetTypeProducts = () => {
            ...
            $.ajax({
                type: "POST",
                url: 'StockRequestEC.aspx/GetTypeProducts', //
        ...
        var GetFilteredStockZone = (StartDate, EndDate) => {
            $.ajax({
                type: 'post',
                url: 'StockRequestEC.aspx/GetFilteredStockZone',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var ModifyRequest = (data) => {
            $.ajax({
                type: 'post',
                url: 'StockRequestEC.aspx/ModifyRequest',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var getProducts = () => {
            $.ajax({
                type: "POST",
                url: 'StockRequestEC.aspx/GetProducts',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    products = rs.d;
        ...
        var save = (data) => {
            $.ajax({
                type: "POST",
                url: 'StockRequestEC.aspx/SaveStockDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ model: data }),
                success: (rs) => {
        ...
        var GetBranchStock = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockRequestEC.aspx/GetBranchStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var GetECStock = () => {
            $.ajax({
                type: 'post',
                url: 'StockRequestEC.aspx/GetECStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var GetIssuedRequest = () => {
            $.ajax({
                type: 'post',
                url: 'StockRequestEC.aspx/GetIssuedRequest',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
