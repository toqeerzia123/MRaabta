<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="PettyCash_Report.aspx.cs" Inherits="MRaabta.Files.PettyCash_Report" %>
        ...
        <span id="Span1" class="tbl-large">
            <asp:GridView ID="GridView" runat="server" AutoGenerateColumns="false" CssClass="mGrid"
                ...
                <Columns>
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:CheckBox ID="chk_all" onclick="HeaderCheckBoxClick(this)" runat="server" />
                        </HeaderTemplate>
                        <ItemTemplate>
