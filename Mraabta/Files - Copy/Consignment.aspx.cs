...
namespace MRaabta.Files
{
    public partial class Consignment : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "redirect", "javascript:serviceChange();", true);
        ...
        protected void btn_SaveConsignment_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (cb_ServiceType.SelectedValue == "Date Box 2Kg")
                {
                    clvar.TotalAmount = 799.00;
                    clvar.gst = 0;
                    clvar.ChargeAmount = 799.00;
                }
                else if (cb_ServiceType.SelectedValue == "Date Box 5Kg")
                {
                    clvar.TotalAmount = 1599.00;
                    clvar.gst = 0;
                    clvar.ChargeAmount = 1599.00;
                }
                else
                {
                    clvar.TotalAmount = double.Parse(hd_amount.Value);
                ...
                if (error == "")
                {
                    ...
                    if (chk_fee.Checked == true)
                    {
                        
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "test", "window.open('"+ "invoicepdf_2.aspx?id=" + txt_ConNo.Text+"','new_Win');window.open('"+ "CTS_ReceiptPrint.aspx?id=" + Encryption(txt_ConNo.Text)+"','Window_X');", true);


                        //string script2_ = @"window.open(""{0}"", ""{1}"", ""{2}"");";
                        //string script2 = String.Format(script2_, "invoicepdf_2.aspx?id=" + txt_ConNo.Text, "_blank", "");
                        //ScriptManager.RegisterStartupScript(this.Page, typeof(Page), "Redirect", script2, true);

                        //string script = String.Format(script_, "CTS_ReceiptPrint.aspx?id=" + txt_ConNo.Text, "_blank", "");
        ...
        protected void btn_SaveConsignment1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                clvar.Othercharges = 0;// txt_Othercharges.Text;
                clvar.Day = rb_1.SelectedValue;
                clvar.expresscenter = cb_originExpresscenter.SelectedValue;//hd_OriginExpressCenter.Value;
                clvar.destinationExpressCenterCode = cities.Select("BranchCode = '" + dd_city.SelectedValue + "'")[0]["ECCODE"].ToString();// hd_Destination_Ec.Value;// cb_Destination.SelectedValue;
                clvar.CustomerClientID = hd_CreditClientID.Value;
                ...
                if (cb_ServiceType.SelectedValue != "Road n Rail" && cb_ServiceType.SelectedValue != "Express Cargo")
                {
                    ...
                    if (cb_ServiceType.SelectedValue == "Date Box 2Kg")
                    {
                        txt_TotalCharges.Text = "799.00";
                        txt_Othercharges.Text = "0.00";
                        txt_TotalAmount.Text = "799.00";
                    }
                    else if (cb_ServiceType.SelectedValue == "Date Box 5Kg")
                    {
                        txt_TotalCharges.Text = "1599.00";
                        txt_Othercharges.Text = "0.00";
                        txt_TotalAmount.Text = "1599.00";
                    }
                    else
                    {
                        // Bilal Modify on 15-08-2020
        ...
        protected void cb_ServiceType_SelectedIndexChanged1(object sender, EventArgs e)
        {
            ...
            */
            ...
            if (cb_ServiceType.SelectedValue == "Date Box 5Kg")
            {
                txt_Weight.Text = "5";
                txt_aWeight.Text = "5";
                txt_vWeight.Text = "5";
