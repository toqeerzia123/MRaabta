<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="StockHODeptReceiving_IMS.aspx.cs" Inherits="MRaabta.Files.StockHODeptReceiving_IMS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <table cellpadding="0" cellspacing="0" width='100%' class='mGrid_Table'>
                <tr>
                    <td colspan="12" align="center" class="head_column">
                        <h3 style="text-align: center">Stocks Recieved (HO Department)                     
                        </h3>
                    </td>
                </tr>
            </table>
                    ...
                    <table class="MainTbl table table-striped">
                        <thead class="">
                            <tr style="font-size: 12px;">
                                ...
                                <th style="width: 15%">Total Req Qty</th>
                                <th style="width: 15%">Total Issued Qty</th>
                    ...
                    <td>
                        <nav>
                                    <div class="nav nav-tabs nav-fill " id="nav-tab" role="tablist">
                                        <a class="nav-item nav-link active" id="nav-about-tab" data-toggle="tab" href="#nav-about" role="tab" aria-controls="nav-about" aria-selected="true">Department Stock</a>
                                          </div>
                            </nav>
                    </td>
                </tr>
    ...
    <script type="text/javascript">
        var getRequests = () => {
            $.ajax({
                type: 'post',
                url: 'StockHODeptReceiving_IMS.aspx/GetIssuances',
        ...
        var getMyStock = () => {
            $.ajax({
                type: 'post',
                url: 'StockHODeptReceiving_IMS.aspx/GetMyStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getHOStock = () => {
            $.ajax({
                type: 'post',
                url: 'StockHODeptReceiving_IMS.aspx/GetHOStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getReceivedRequestDetails = (id) => { 
            $.ajax({
                type: 'post',
                url: 'StockHODeptReceiving_IMS.aspx/GetIssuancesDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        var save = (ID) => {
            $.ajax({
                type: 'post',
                url: 'StockHODeptReceiving_IMS.aspx/SaveReceivedPerIssued',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ ID: ID }),
                success: (rs) => {
