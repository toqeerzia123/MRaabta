...
{
    public partial class BarcodePrinter__QA : System.Web.UI.Page
    {
        ...
        public string NewPrinting(DataRow dr, int i)
        {
            ...
            "                        <div style=\"width: 100%; font-family:IDAutomationHC39M; text-align:center; font-size:17px;\">\n" +
            ...
            // "                        <div style=\"text-align: center; font-size:x-large; font-weight: Bold;\">" + i + " of " + dr["pieces"].ToString() + " Pcs</div>\n" +
            "                        <div style=\"text-align: center; font-size:18px; font-weight: Bold;\">" + i + " of " + dr["pieces"].ToString() + " Pcs</div>\n" +
        ...
        public DataTable GetConsignmentNumbers(List<string> GP, Cl_Variables clvar)
        {
           ...
           "       destination,\n" +
           "       org.sname           Origin,\n" +
           "       dest.sname          DestName, c.CouponNumber\n" +
           "  from consignment c\n" +
