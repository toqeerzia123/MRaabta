...
{
    public partial class StockRequestZone : System.Web.UI.Page
    {
        ...
        {
            //return new ZoneStockRequestRespo().GetHOStock(ZoneCode);
            try
            {
                con.Open();
        ...
        {
            //return new ZoneStockRequestRespo().GetZoneStock(ZoneCode);
            try
            {
                con.Open();
        ...
        { 
            ...
            try
            {
                ...
                var rs = con.Query<StockRequestModel>(@"select sr.ID, sr.TotalReqQty, FORMAT(sr.TotalReqQty,N'N0')  TotalReqQty_, case when si.StockReqID is null then 0 else 1 end as [IsUpdated]  
                                                    ...
                                                    sr.UserTypeID = '1003'and sr.CreatedOn between @startt +' 00:00:00.000' and @endd+' 23:59:59.999 ';", new { @Zone = HttpContext.Current.Session["ZONECODE"].ToString(), @startt = StartDate, @endd = EndDate });
        ...
        public static StockRequestDetailModel GetFilteredStockZonePer(String Id)
        {
            ...
            //return new ZoneStockRequestRespo().GetFilteredStockZonePer(Id);
            try
            {
                con.Open();
        ...
        public static string SaveStockDetails(StockRequestModel model)
        {
            ...
            model.ZoneCode = HttpContext.Current.Session["ZONECODE"].ToString();
            model.UserTypeId = UserType;
            //var rs = new ZoneStockRequestRespo().SaveStockDetails(model, ZoneCode);
            con.Open();
            object rs;
            using (var tran = con.BeginTransaction())
            {
        ...
        {
            //return new ZoneStockRequestRespo().GetRequestsDetails(id);
            try
            {
                con.Open();
