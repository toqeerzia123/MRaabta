<%@ Page Language="C#" Title="Receipt Voucher" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="ReceiptVoucher.aspx.cs" Inherits="MRaabta.Files.ReceiptVoucher" %>
            ...
            <asp:Panel ID="panel1" runat="server">
                <table style="font-family: Calibri; font-size: medium; padding-bottom: 0px !important;
                    ...
                    <tr>
                        ...
                        <td class="input-field" style="width: 15% !important;">
                            <asp:DropDownList ID="dd_type" runat="server" AppendDataBoundItems="true" Width="100%"
                                onchange="TypeChange(this)" AutoPostBack="true" OnSelectedIndexChanged="dd_type_SelectedIndexChanged">
                    ...
                    <tr id="stw" runat="server" style="display: none;">
                        <td class="field" style="width: 10% !important; text-align: right !important;">
                        </td>
                        <td class="input-field rabi" style="width: 15% !important; float: left;">
                        </td>
                        <td class="space" style="width: 12% !important; margin: 0px 0px 0px 0px !important;
                            text-align: right !important;">
                        </td>
                        <td class="input-field rabi" style="width: 15% !important;">
                        </td>
                        <td class="space" style="width: 3% !important; margin: 0px 0px 0px 0px !important;">
                        </td>
                        <td class="field" style="width: 10% !important; text-align: right !important; padding-right: 5px!important;">
                            STW Number
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="input-field" style="width: 15% !important;">
                            <asp:DropDownList ID="dd_EC" runat="server" Width="100%" AppendDataBoundItems="false"
                    ...
                    <tr>
                        ...
                        <td class="input-field" style="width: 15% !important;">
                            ...
                            <asp:TextBox ID="txt_rider" runat="server" AutoPostBack="true" Enabled="false" OnTextChanged="txt_rider_TextChanged"></asp:TextBox>
                        </td>
                        <td class="space" style="width: 2% !important; margin: 0px 0px 0px 0px !important;">
                        </td>
                        <td class="field" style="width: 10% !important; text-align: right !important; padding-right: 5px!important;">
                    ...
                    <tr>
                        ...
                        <td class="input-field" style="width: 15% !important;">
                            <asp:DropDownList ID="dd_paySource" runat="server" AppendDataBoundItems="true" onchange="PaymentSourceChange(this)"
                                AutoPostBack="true" OnSelectedIndexChanged="dd_paySource_SelectedIndexChanged1">
                    ...
                    <tr>
                        ...
                        <asp:UpdatePanel ID="up1" runat="server">
                            <ContentTemplate>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_clientGroup" runat="server" Style="width: 80px; margin-left: 20px;"
                                        AutoPostBack="true" OnTextChanged="ValidateClientGroup"></asp:TextBox>
                                </td>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </tr>
