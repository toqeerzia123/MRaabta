<%@ Page Title="HPS Booking" Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="BookingEC.aspx.cs" Inherits="MRaabta.Files.BookingEC" %>
                ...
                <fieldset style="height: 398px;">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txt_RiderCode" runat="server" MaxLength="8" Width="70px" Enabled="true">
                                </asp:TextBox>
