...
{
    public partial class MegaBagging : System.Web.UI.Page
    {
        ...
        protected void Btn_Update_Click(object sender, EventArgs e)
        {
            ...
            string error = UpdateBag(clvar, dt_head);
            if (error == "")
            {
        ...
        public string UpdateBag(Variable clvar, DataTable manifest)
        {
            clvar._StateId = "3";
        ...
        [WebMethod]
        public static string InsertBag(ManifestModel[] manifests, BagModel bag)
        {
            string status = "";
            if (bag.Type == "1")
            {
            ...
            new DataColumn("Pieces", typeof(int))
                ...
                //Insert Bag
                status = GenerateBag(clvar, dt_manifest);
        ...
        public static string GenerateBag(Cl_Variables clvar, DataTable dt1)
        {
            SqlConnection sqlcon = new SqlConnection(clvar.Strcon());
