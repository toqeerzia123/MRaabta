...
{
    public partial class TrackBag_QA : System.Web.UI.Page
    {
        ...
        {
            load_bagdata("rbtn_indexchanged");
            ...
            //    else
            //    {
            //        AlertMessage("Selecting Final. This Branch is not the Destination of this Bag");
            ...
            //        AlertMessage("Rerouting this Bag. This is the Destination");
        ...
        {
            load_bagdata("bag_textchanged");
        }

        void load_bagdata(string func)
        {
            ViewState["WB"] = "0";
            gv_bagManifests.DataSource = null;
            gv_bagManifests.DataBind();
            ...
            if (txt_bagNo.Text.Trim(' ') != "")
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    //    }
                    //}
                    //if (func == "bag_textchanged" || (func == "rbtn_indexchanged" && rbtn_status.SelectedValue == "1"))
                    //{
                    //if (dt.Rows[0]["Destination"].ToString() == Session["BranchCode"].ToString())
                    //{
                    //rbtn_status.SelectedValue = "1";
        ...
        protected void btn_save_Click(object sender, EventArgs e)
        {
            ...
            clvar.destination = HttpContext.Current.Session["BranchCode"].ToString();// dd_destination.SelectedValue;// hd_destination.Value;
            ...
            if (hd_debagWithoutBag.Value == "1")
            {
                ...
                {
                    AlertMessage("Selecting Reroute For This Bag. Destination is this Branch");
                    return;
                }
                else if (dd_destination.SelectedValue != HttpContext.Current.Session["BranchCode"].ToString() && rbtn_status.SelectedValue == "1")
                {
                    AlertMessage("Selecting Final For This Bag. Destination is not this Branch");
                    return;
                }
        ...
        protected void txt_outpiece_TextChanged(object sender, EventArgs e)
        {
            ...
            if (dt_ != null)
            {
                ...
                foreach (GridViewRow row in gv_outpieces.Rows)
                {
                    ...
                    //if (chk_received.Checked)
                    //{
                    //    if (txt_descStatus.Text.ToUpper() == "RECEIVED")
                    //    {
                    //        hd_statusCode.Value = "5";
                    //    }
                    //    else
