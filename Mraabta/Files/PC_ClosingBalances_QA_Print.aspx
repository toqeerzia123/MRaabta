            ...
            <asp:Repeater ID="rp_data" runat="server" OnItemDataBound="rp_data_ItemDataBound">
                <HeaderTemplate>
                    <table class="mGrid">
                        <tr>
                            ...
                            <th rowspan="2">Branch (With HBL Konnect)
                            </th>
                            <th colspan="2">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:HyperLink ID="hl_BranchName_Hbl" runat="server" Target="_blank" Text='<%# DataBinder.Eval(Container.DataItem, "BranchName") %>'></asp:HyperLink>
                        </td>
