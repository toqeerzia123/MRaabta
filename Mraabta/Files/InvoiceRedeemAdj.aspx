<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="InvoiceRedeemAdj.aspx.cs" Inherits="MRaabta.Files.InvoiceRedeemAdj" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table style="font-family: Calibri; font-size: medium; padding-bottom: 0px !important; padding-top: 10px !important; width: 97%"
        ...
        <tr style="margin: 0px 0px 0px 0px !important;">
            <td class="field" style="width: 32% !important;">Search By
            </td>
            <td class="space" style="width: 2% !important; margin: 0px 0px 0px 0px !important;"></td>
            <td class="field" style="width: 15% !important;"></td>
            <td class="space" style="width: 2% !important; margin: 0px 0px 0px 0px !important;"></td>
        </tr>
        <tr>
            <td class="input-field" style="width: 32% !important;">
