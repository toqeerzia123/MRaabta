<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="PettyCash_BranchEdit.aspx.cs" Inherits="MRaabta.Files.PettyCash_BranchEdit" %>
        ...
        <table class="input-form" style="width: 95%;">
            ...
            <tr>
                ...
                <td class="input-field">
                    <asp:TextBox ID="txt_frmdate" runat="server" CssClass="med-field" MaxLength="10" Width="190"
                ...
                <td class="input-field">
                    <asp:TextBox ID="txt_todate" runat="server" CssClass="med-field" MaxLength="10" Width="190"
                        onkeypress="return false;"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="input-field">
                    <asp:DropDownList ID="dd_branch" runat="server" CssClass="dropdown width" Width="200" OnSelectedIndexChanged="dd_branch_SelectedIndexChanged"
                        AutoPostBack="true">
                    </asp:DropDownList>
                </td>
                <td class="field"></td>
                ...
                <td class="input-field">
                    <asp:DropDownList ID="dd_ec" runat="server" CssClass="dropdown width" Width="200">
                    </asp:DropDownList>
                </td>
                <td>
            ...
            <asp:GridView ID="GridView" runat="server" AutoGenerateColumns="false" CssClass="mGrid"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Voucher ID" ItemStyle-HorizontalAlign="center">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkYes" readonly="true" runat="server" Text='<%#Bind("voucher_id") %>'
                                CommandName="redirect">
                            </asp:LinkButton>
                            <asp:HiddenField ID="hf_status" runat="server" Value='<%# Eval("status_code")%>' />
                            <asp:HiddenField ID="hf_head_id" runat="server" Value='<%# Eval("head_id")%>' />
                    ...
                    <asp:BoundField HeaderText="Express Center" DataField="ec" ItemStyle-HorizontalAlign="left"
                        ItemStyle-Width="20%"></asp:BoundField>
                    <%--         <asp:BoundField HeaderText="Form Type" DataField="expense" ItemStyle-HorizontalAlign="left"
                        ItemStyle-Width="20%"></asp:BoundField>--%>
                    <asp:BoundField HeaderText="Head Of Account" DataField="sub_desc" ItemStyle-HorizontalAlign="left"
                        ItemStyle-Width="20%"></asp:BoundField>
                    ...
                    <asp:BoundField HeaderText="Amount" DataField="amount" ItemStyle-HorizontalAlign="right"
                        ItemStyle-Width="20%"></asp:BoundField>
                    <asp:BoundField HeaderText="Status" DataField="status" ItemStyle-HorizontalAlign="right"
                        ItemStyle-Width="20%"></asp:BoundField>
                </Columns>
            </asp:GridView>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
