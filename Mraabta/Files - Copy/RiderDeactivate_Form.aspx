<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="RiderDeactivate_Form.aspx.cs" Inherits="MRaabta.Files.RiderDeactivate_Form" %>
    ...
    <div>
        <table>
            <tr>
                ...
                <td>
                    <asp:CheckBox runat="server" ID="chk_Deactivate" AutoPostBack="true" OnCheckedChanged="chk_Deactivate_CheckedChanged" />
                </td>
            </tr>
        </table>
    </div>
