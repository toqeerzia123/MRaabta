...
{
    public class RidersLocationController : ApiController
    {
        RidersLocationDB Rider_LocationDB;

        public RidersLocationController()
        {
            Rider_LocationDB = new RidersLocationDB();
        }
        /// <summary>
