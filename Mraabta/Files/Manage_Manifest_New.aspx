<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="Manage_Manifest_New.aspx.cs" Inherits="MRaabta.Files.Manage_Manifest_New" %>
        ...
        <tr>
            ...
            <td class="input-field" style="width: 15% !important;">
                <asp:TextBox ID="txt_manifestNo" runat="server" MaxLength="12" AutoPostBack="true"
                    OnTextChanged="txt_manifestNo_TextChanged" Width="100%"></asp:TextBox>
            </td>
            <td class="space">
            </td>
            <td class="field" style="width: 10% !important;">
                        ...
                        <asp:GridView ID="gv_consignments" runat="server" AutoGenerateColumns="false" CssClass="mGrid"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Origin" HeaderStyle-Width="17.5%">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="dd_gorigin" runat="server" AppendDataBoundItems="true" AutoPostBack="true"
                                ...
                                <asp:TemplateField HeaderText="Weight" HeaderStyle-Width="5%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txt_gWeight" MaxLength="4" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Weight") %>'
                                            CssClass="newbox" Width="50px"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Pieces" HeaderStyle-Width="5%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txt_gPieces" runat="server" CssClass="newbox" Text='<%# DataBinder.Eval(Container.DataItem, "Pieces") %>'
                                ...
                                <asp:TemplateField HeaderStyle-Width="5%" Visible="false">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="dd_gStatus" runat="server">
                                        </asp:DropDownList>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
