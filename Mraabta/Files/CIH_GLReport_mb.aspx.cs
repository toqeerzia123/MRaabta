...
{
    public partial class CIH_GLReport_mb : System.Web.UI.Page
    {
        ...
        protected void btn_add_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ScriptManager.RegisterStartupScript(Page, typeof(Page), "OpenWindow", "window.open('CIH_GLprint_mb.aspx?from=" + frm_date + "&to=" + to_date + "&branch=" + branch_val + "&bname=" + branch_name + "&company=" + company + "');", true);
