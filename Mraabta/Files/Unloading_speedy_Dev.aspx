<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Unloading_speedy_Dev.aspx.cs" Inherits="MRaabta.Files.Unloading_speedy_Dev" MasterPageFile="~/BtsMasterPage.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function RemoveCN(obj) {
            ...
            $.ajax({
                url: 'Unloading_speedy_Dev.aspx/RemoveCN',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                data: Code,
    ...
    <script language="javascript" type="text/javascript">
        ...
        function SaveUnloading_BAG(tr, mode) {
            ...
            tbl_bag_array[10] = tr.cells[11].getElementsByClassName('hidden')[0].value;
            tbl_bag_array[11] = tr.cells[12].getElementsByClassName('hidden')[0].value;
            tbl_bag_array[12] = tr.cells[13].getElementsByClassName('hidden')[0].value;
            tbl_bag_array[13] = tr.cells[14].getElementsByClassName('hidden')[0].value;
            tbl_bag_array[14] = tr.cells[15].innerHTML;
            ...
            var Bag = {
                ...
                hd_origin: tbl_bag_array[10],
                hd_descStatus: tbl_bag_array[11],
                hd_destination: tbl_bag_array[12],
                bagStatus: tbl_bag_array[13],
                loadingID: tbl_bag_array[14]
            ...
            $.ajax({
                ...
                url: 'Unloading_speedy_Dev.aspx/save_BAG',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
        ...
        function SaveUnloading_CN(tr, mode) {
            ...
            tbl_cn_array[12] = tr.cells[9].innerHTML;
            ...
            $.ajax({
                ...
                url: 'Unloading_speedy_Dev.aspx/save_CN',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                data: JSON.stringify(jsonObj),
        ...
        function checkValidations(txt) {
            ...
            $.ajax({
                async: false,
                type: 'post',
                url: 'Unloading_speedy_Dev.aspx/CheckControls',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function SaveChangedValues() {
            ...
            if ((jsonObj.Bags.length > 0 || jsonObj.Consignments.length > 0) && unloadingID != "0") {
                $.ajax({
                    url: 'Unloading_speedy_Dev.aspx/SaveChangedValues',
                    type: 'POST',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    data: JSON.stringify(jsonObj),
        ...
        function getData() {
            ...
            $.ajax({
                url: 'Unloading_speedy_Dev.aspx/GetBagNo',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                data: Code,
        ...
        function OnSuccess(response) {
            ...
            if (count - 1 > 0) {
                ...
                var vid = document.getElementById('<%= h_vid.ClientID %>');
                for (var i = 0; i < count - 1; i++) {
                    ...
                    col = newTr.insertCell(15);
                    newTr.cells[15].innerText = vid.value;
        ...
        function getdt(response) {
            ...
            if ((count - 1) > 0) {
                for (var i = 0; i < count - 1; i++) {
                    ...
                    ///////////vidlabel////////////////////
                    col = newTr.insertCell(15);
                    newTr.cells[15].innerText = dt.Table1[i][12];
                }
            }
            validate();
        ...
        function getDTC(response) {
            ...
            $.ajax({
                url: 'Unloading_speedy_Dev.aspx/Cities',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                datatype: 'json',
                data: '',
                success: function (result) {
                    ...
                    if (count - 1 > 0) {
                        for (var i = 0; i < count - 1; i++) {
                            ...
                            ///////////vidlabel////////////////////
                            col = newTr.insertCell(9);
                            newTr.cells[9].innerText = dt.Table1[i][10];
                        }
        ...
        function getData_Consignment() {
            ...
            $.ajax({
                url: 'Unloading_speedy_Dev.aspx/GetCNNo',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                data: Code,
        ...
        function OnSuccess_CN(response) {
            ...
            if (count - 1 > 0) {
                for (var i = 0; i < count - 1; i++) {
                    ...
                    var hd_vid = document.createElement('hd_vid');
                    hd_vid.type = 'hidden';
                    hd_vid.className = 'hidden';
                    hd_vid.value = txt_vid.value;
                    hd_vid.style.textAlign = 'center';
                    hd_vid.id = 'hd_vid'
                    //   btn_remove.onclick = RemoveConsignment.bind(newTr.cells[0].childNodes[0], newTr.cells[0].childNodes[0]);
                    ...
                    ///////////VID////////////////////
                    col = newTr.insertCell(9);
                    newTr.cells[9].innerText = txt_vid.value;
        ...
        function CalculateTotalWeight() {
            ...
            var validNumberP = new RegExp(/^[1-9][0-9]*$/);
            for (var i = 1; i < cns.rows.length; i++) {
                if (validNumberP.test(cns.rows[i].cells[6].childNodes[0].value) && (cns.rows[i].cells[6].childNodes[0].value != "0")) {
            ...
            if (chk) {
                ...
                txt_bagno.disabled = true;
                alert('Kindly insert proper weight/pieces');
                return;
            }
            else {
        ...
        function validate() {
            ...
            for (var i = 1; i < cns.rows.length; i++) {
                ...
                var validNumberW = new RegExp(/^\d+(\.\d+)?$/);

            for (var i = 1; i < bags.rows.length; i++) {
                if (validNumberW.test(bags.rows[i].cells[7].childNodes[0].value) && (bags.rows[i].cells[7].childNodes[0].value != "0")) {
                    bags.rows[i].cells[7].childNodes[0].style.backgroundColor = "";
                }
                else {
                    bags.rows[i].cells[7].childNodes[0].style.backgroundColor = "red";
            ...
            for (var i = 1; i < cns.rows.length; i++) {
                if (validNumberW.test(cns.rows[i].cells[5].childNodes[0].value) && (cns.rows[i].cells[5].childNodes[0].value != "0")) {
                    cns.rows[i].cells[5].childNodes[0].style.backgroundColor = "";
                }
                else {
                    cns.rows[i].cells[5].childNodes[0].style.backgroundColor = "red";
        ...
        function btn_okDialogue_Click() {
            ...
            for (var i = 1; i < tblCn.rows.length; i++) {
                ...
                var Consignment = {
                    ...
                    vid: tr.cells[9].innerText // VID Addition
                };
                jsonObj.Consignments.push(Consignment);
            }
            $.ajax({
                url: 'Unloading_speedy_Dev.aspx/SaveChangedValues_saveButton',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',
                data: JSON.stringify(jsonObj),
    ...
    <table class="input-form" style="width: 95%;">
        <tr>
            ...
            <td colspan="5"><a href="search_unloading.aspx" target="_blank" class="button">Search UnLoading</a></td>
        </tr>
        <tr>
            <td colspan="8">
                <h3>Loading Detail</h3>
                <div>
                    <asp:GridView Width="100%" ID="gvLoading" CssClass="tblDetails" AutoGenerateColumns="false" GridLines="Both" 
                        runat="server" HeaderStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Left" OnRowCommand="gvLoading_OnRowCommand">
                        <Columns>
                            <asp:BoundField DataField="loadingID" HeaderText="Loading No" ItemStyle-Width="20%" />
                            <asp:BoundField DataField="Route" HeaderText="Route"  ItemStyle-Width="20%"/>
                            <asp:BoundField DataField="Origin" HeaderText="Origin"  ItemStyle-Width="20%"/>
                            <asp:BoundField DataField="Bag" HeaderText="Bags Count"  ItemStyle-Width="10%"/>
                            <asp:BoundField DataField="CN" HeaderText="CNs Count"  ItemStyle-Width="10%"/>
                            <asp:BoundField DataField="Weight" HeaderText="Total Weight" ItemStyle-Width="10%"/>
                            <asp:TemplateField ShowHeader="False" ItemStyle-Width="10%">
                                <ItemTemplate>
                                    <asp:Button ID="btnDel" runat="server" CausesValidation="false" CommandName="Del"
                                        Text="Delete" CommandArgument='<%# Eval("loadingID") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
        ...
        <tr>
            <td class="lbl">Courier Name:
            </td>
            <td class="fld">
                <asp:TextBox ID="txt_couriername" runat="server"></asp:TextBox>
            </td>
            <td class="spc"></td>
            <td class="lbl">Loading Seal Number:
            </td>
            <td class="fld">
        ...
        <tr id="flight" runat="server">
            <td class="lbl">Flight Number:
            </td>
            <td class="fld">
                <asp:TextBox ID="txt_flight" runat="server"></asp:TextBox>
            </td>
            <td class="spc"></td>
            <td class="lbl">Departure Flight Date
            </td>
            <td class="fld">
    ...
    <div id="rd_div" runat="server">
        <div class="tabs">
            <div class="tab">
                <div class="tab_radio" style="margin-left:16px;">
                    <span>
                ...
                <div class="content" id="tab_1_Div" runat="server" style="height: 300px;margin-top:10px;margin-left:15px">
                    <table class="input-form boxbg">
                        <tr id="bag_div" runat="server">
                            <td class="field" style="width:50px;">Bag No:</td>
                            ...
                            <td style="background-color: #8cf78c">Last Scanned Item</td>
                        </tr>
                    </table>
                    <asp:Label ID="lbl_new" runat="server" CssClass="error_msg"></asp:Label>
                    <div style="width: 100%;">
                        <table id="tbl_bagnew" class="tblDetails" style="overflow: scroll; height: 300px;margin-top:10px;margin-left:15px">
                            <tr>
                                <th style="width: 100px;">Recieved</th>
                                <th style="width: 90px;">Bag No</th>
            ...
            <div class="tab">
                <div class="content" id="tab_2_Div" runat="server" style="overflow: scroll;height: 300px;margin-top:10px;margin-left:15px">
                    <table class="input-form boxbg">
                        <tr>
                            <td class="field" style="width:100px;">Consignment No:
                            </td>
                            <td class="auto-style1">
                    ...
                    <div style="width: 100%;">
                        <table id="tbl_cns" class="tblCN">
                            <tr>
                                <th style="width: 5%; text-align: center;">Recieved</th>
