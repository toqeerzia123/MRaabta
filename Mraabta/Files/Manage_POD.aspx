                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Reason">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hd_DRTV" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "IsDRTV") %>' />
                            <asp:HiddenField ID="hd_SupplierBranch" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "SupplierBranch") %>' />
                            <asp:HiddenField ID="hd_RunSheetBranch" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "RunSheetBranchCode") %>' />
                            <asp:HiddenField ID="hd_ActNo" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "ActNo") %>' />b
