...
{
    public partial class BarcodePrinter : System.Web.UI.Page
    {
        ...
        public string NewPrinting(DataRow dr, int i)
        {
            ...
            "                    </td>\n" +
            "                    <td>\n" +
            "                        <div style=\"width: 100%; font-family:IDAutomationHC39M; text-align:center; font-size:13pt;\">\n" +
            ...
            "                </tr>\n" +
            "                <tr>\n" +
            "                    <td style=\"font-size: 14pt; font-family: Calibri; text-align:center; font-weight:bold;\">\n" +
            "                        <label>" + dr["DestName"].ToString() + "</label>\n" +
            "\n" +
            "                    </td>\n" +
            "                    <td style=\"font-size: Small; font-family: Calibri; text-align: center;\">\n" +
            "                        <div style=\"text-align: center; font-size:large; font-weight: Bold;\">" + i + " of " + dr["pieces"].ToString() + " Pcs</div>\n" +
            ...
            "                    <td></td>\n" +
            "\n" +
            "                    <td style=\"font-size: Medium; font-weight:bold; font-family: Calibri; text-align: center;\">\n" +
            //"                        <br />\n" +
            "                        " + dr["ServiceTypeName"].ToString().ToUpper() + "\n" +
            "                    </td>\n" +
            "\n" +
            "                    <td></td>\n" +
            "                </tr>\n" +
        ...
        public DataTable GetConsignmentNumbers(List<string> GP, Cl_Variables clvar)
        {
           ...
           "       destination,\n" +
           "       org.sname           Origin,\n" +
           "       dest.sname          DestName, c.CouponNumber, c.serviceTypeName\n" +
           "  from consignment c\n" +
