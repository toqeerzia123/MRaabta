...
{
    public partial class CODPaymentsMultiBranches : System.Web.UI.Page
    {
        ...
        protected void Btn_Search_Click(object sender, EventArgs e)
        {
            if (type.SelectedValue == "html")
            {
                ...
                if (clvar.StartDate != null && clvar.Status != "" || 1 == 1)
                {
                    ...
                    for (int i = 0; i < creditClient.Rows.Count; i++)
                    {
                        cvar.CreditClientID += "'" + creditClient.Rows[i][0].ToString() + "',";
                    }

                    cvar.CreditClientID = cvar.CreditClientID.Remove(cvar.CreditClientID.Length - 1);
                    cvar.CreditClientID.ToString();
        ...
        */
        ...
        public DataTable GetInvoicesForVoucherNonCentralized(Cl_Variables clvar)
        {
            ...
            "\n" +
            "WHERE  b.clientId in (" + clvar.CreditClientID + ") and cc.sectorid != '0'\n" +
