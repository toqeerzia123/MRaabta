...
namespace MRaabta.Repo
{
    public class LoadingRepo
    {
        ...
        public async Task<string> InsertLoading(LoadingModel model)
        {
            ...
            try
            {
                ...
                if (rs > 0)
                {
                    ...
                    foreach (var item in model.GridData.Where(x => x.IsBag))
                    {
        ...
        public async Task<long> UpdateLoading(LoadingModel model)
        {
            SqlTransaction trans = null;
            try
            {
                ...
                var detailsToAdd = model.GridData.Where(x => !oldLoading.details.Select(y => y.BagCN).Contains(x.BagCN)).ToList();
