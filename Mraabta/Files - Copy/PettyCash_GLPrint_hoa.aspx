<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PettyCash_GLPrint_hoa.aspx.cs" Inherits="MRaabta.Files.PettyCash_GLPrint_hoa" %>
...
<body>
    ...
    <asp:HiddenField ID="hf_ec" runat="server" />
     ...
     <asp:HiddenField ID="hf_ft" runat="server" />
     <asp:HiddenField ID="hf_hoa" runat="server" />
        ...
        <table border="0" width="100%">
            <tr>
                ...
                <td align="center" colspan="2" width="50%">
                    ...
                    <asp:Label Text="M&amp;P Express Logistics Pvt. Ltd." runat="server" ID="lbl_company">
                    </asp:Label></b></font>
                </td>
                <td align="right" width="25%">
            ...
            <tr>
                ...
                <td align="center" colspan="2" width="50%">
                    <font color="#000000" face="verdana"><span class="style1">Expense Wise Ledger</span></font>
                </td>
                <td align="right" width="25%">
                    &nbsp;
                </td>
     ...
     <%--       <tr>
                <td width="25%" class="style2">
                    <font color="#000000" face="verdana" size="1" class="style2"><b>Year : </b>
                        <asp:Label ID="lbl_year" runat="server"></asp:Label></font>
                </td>
                <td align="center" colspan="2" class="style5">
                    &nbsp;
                </td>
                <td align="right" width="25%">
                    <font color="#000000" face="verdana" size="1" class="style2"><b>Month : </b>
                        <asp:Label ID="lbl_month" runat="server"></asp:Label></font>
                </td>
            </tr>--%>
            <%--   <tr>
                <td width="25%" class="style2">
                    <font color="#000000" face="verdana" size="1" class="style2"><b>Prepared By : </b>
                        <asp:Label ID="lbl_created_by" runat="server"></asp:Label></font>
                </td>
                <td align="center" colspan="2" class="style5">
                    &nbsp;
                </td>
                <td align="right" width="25%">
                    <font color="#000000" face="verdana" size="1" class="style2"><b>Prepared On : </b>
                        <asp:Label ID="lbl_created_date" runat="server"></asp:Label></font>
                </td>
            </tr>--%>
        </table>
        <br />
        ...
        <span id="Span1" class="tbl-large">
            <asp:GridView ID="GridView" runat="server" AutoGenerateColumns="false" CssClass="mGrid"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Head Of Account" DataField="description" ItemStyle-HorizontalAlign="left"
                        ItemStyle-Width="30%"></asp:BoundField>
                    <asp:BoundField HeaderText="Particulars" DataField="narrate" ItemStyle-HorizontalAlign="left"
                        ItemStyle-Width="20%"></asp:BoundField>
                    <asp:BoundField HeaderText="Debit" DataField="dnote" ItemStyle-HorizontalAlign="right" DataFormatString="{0:N0}"
                        ItemStyle-Width="10%"></asp:BoundField>
                    <asp:BoundField HeaderText="Credit" DataField="cnote" ItemStyle-HorizontalAlign="right" DataFormatString="{0:N0}"
                        ItemStyle-Width="10%"></asp:BoundField>
                    <asp:BoundField HeaderText="Balance" DataField="balance" ItemStyle-HorizontalAlign="right" DataFormatString="{0:N0}"
                        ItemStyle-Width="10%"></asp:BoundField>
                </Columns>
            </asp:GridView>
            <table border="0" width="100%">
