<%@ Page Title="" Language="C#" MasterPageFile="~/BtsMasterPage.Master" AutoEventWireup="true" CodeBehind="BulkConsignmentApproval.aspx.cs" Inherits="MRaabta.Files.BulkConsignmentApproval" %>
        ...
        function BulkCnChange() {
            ...
            if (cnFrom.value.trim() != "" && numberOfCN.value.trim() != "") {
                $.ajax({
                    ...
                    url: 'BulkConsignmentApproval.aspx/GetConsignmentDetails',
                    type: 'POST',
        ...
        function SaveToDB() {
            ...
            if (details.Consignments.length > 0) {
                $.ajax({
                    ...
                    url: 'BulkConsignmentApproval.aspx/SaveToDb',
                    type: 'POST',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
