<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="PettyCash_ApprovalReport.aspx.cs" Inherits="MRaabta.Files.PettyCash_ApprovalReport" %>
    ...
    <div>
        ...
        <table class="input-form" style="width: 95%;">
            ...
            <tr>
                ...
                <td class="input-field">
                    <asp:DropDownList ID="dd_status" runat="server" CssClass="dropdown width" Width="200">
        ...
        <span id="Span1" class="tbl-large">
            <asp:GridView ID="GridView" runat="server" AutoGenerateColumns="false" CssClass="mGrid"
                ...
                BorderWidth="1px">
                <Columns>
                    <asp:BoundField HeaderText="Voucher ID" DataField="voucher_id" ItemStyle-HorizontalAlign="left"
                    ...
                    <asp:BoundField HeaderText="Date" DataField="date" ItemStyle-HorizontalAlign="Center"
                        ItemStyle-Width="20%"></asp:BoundField>
                    <asp:BoundField HeaderText="Created On" DataField="created_on" ItemStyle-HorizontalAlign="Center"
                        ItemStyle-Width="20%"></asp:BoundField>
                    <asp:BoundField HeaderText="Created By" DataField="created_by" ItemStyle-HorizontalAlign="Center"
                        ItemStyle-Width="20%"></asp:BoundField>
