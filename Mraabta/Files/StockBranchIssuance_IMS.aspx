<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="StockBranchIssuance_IMS.aspx.cs" Inherits="MRaabta.Files.StockBranchIssuance_IMS" %>
...
<asp:Content ID="form1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="shadow rounded">
                <div class="">
                    ...
                    <div class="row ml-2 mt-2">
                        <div class="col-md-5">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-1 col-form-label mt-1" style="font-size: 12px;">Branches</label>
    ...
    <script type="text/javascript">
        var getBranches = () => {
            ...
            $.ajax({
                type: "POST",
                url: 'StockBranchIssuance_IMS.aspx/GetBranches',
        ...
        var getRequests = (id, startdate, enddate) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockBranchIssuance_IMS.aspx/GetRequests',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        var getMyStock = () => {
            $.ajax({
                type: 'post',
                url: 'StockBranchIssuance_IMS.aspx/GetMyStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getZoneStock = (zone, branch) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockBranchIssuance_IMS.aspx/GetBranchStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var getRequestDetails = (id, isupdated, zone, name) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockBranchIssuance_IMS.aspx/GetRequestsDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var save = (data) => {
            $.ajax({
                type: 'post',
                url: 'StockBranchIssuance_IMS.aspx/SaveIssuanceDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
