<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master"   CodeBehind="COD_ReversePickupCODPortalReport.aspx.cs" Inherits="MRaabta.Files.COD_ReversePickupCODPortalReport" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <script type="text/javascript">
        ...
        function getZones() {
            var pageZone ='<%=ResolveUrl("~/Files/COD_ReversePickupCODPortalReport.aspx/GetZones")%>';
            var pageAccount = '<%=ResolveUrl("~/Files/COD_ReversePickupCODPortalReport.aspx/GetAccounts")%>';
        ...
        function Search_Click() {
            var PageSearchData = '<%=ResolveUrl("~/Files/COD_ReversePickupCODPortalReport.aspx/Search_Click")%>';
            var PageSearchDataCSV = '<%=ResolveUrl("~/Files/COD_ReversePickupCODPortalReport.aspx/Search_CSV_Click")%>';
    ...
    <table cellpadding="0" cellspacing="0" width='100%' class='mGrid_Table'>
        <tr>
            <td colspan="12" align="center" class="head_column">
                <h3 style="text-align: center">Reverse Pickup COD Portal Report
                </h3>
            </td>
        </tr>
    </table>
