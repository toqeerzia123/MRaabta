<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="CIH_GLReport_mb.aspx.cs" Inherits="MRaabta.Files.CIH_GLReport_mb" %>
    ...
    <div>
        ...
        <table class="input-form" style="width: 95%;">
            ...
            <tr>
                ...
                <td class="input-field">
                    <asp:ListBox SelectionMode="Multiple" ID="dd_branch" runat="server"
                        CssClass=" dropdown width"
