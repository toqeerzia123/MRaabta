...
{
    public partial class CODPayments_New : System.Web.UI.Page
    {
        ...
        */
        ...
        public DataSet Get_CreditClientAccounts(Variable clvar)
        {
            ...
            try
            {
                ...
                string sql = "SELECT CC.ACCOUNTNO ACCOUNTNO, \n"
                           + "       CC.NAME + ' ( ' + CC.ACCOUNTNO + ' )' NAME \n"
                           + "FROM   CREDITCLIENTS CC \n"
                           + "INNER JOIN CODUsers c ON cc.id = c.CreditClientID \n"
                           + "WHERE  CC.ISCOD = '1' AND CC.CODTYPE !='3' \n";
        ...
        [WebMethod]
        public static List<Payments> GetPaymentData(string zone, string customer, string payable_amount)
        {
            ...
            DataTable dt = GetInvoicesForVoucherNonCentralized(clvar_, condtion);
        ...
        public static DataSet Get_CODPaymentReport_New(string accountNo, string paidstatus, Variable clvar)
        {
            ...
            try
            {
                ...
                "                  C.TRANSACTIONNUMBER,\n" +
                "                  PV.VOUCHERDATE,B4.SNAME, PV.amount, PV.AmountUsed, R.STATUS) B\n" +
                " where (RRSTATUS = 'D-DELIVERED' OR RRSTATUS = 'WRO-Writeoff Case') " + paidstatus + " \n" +
                " ORDER BY 1";
        ...
        public static DataTable GetInvoicesForVoucherNonCentralized(Cl_Variables clvar, string condtion)
        {
           ...
           + "           HAVING SUM(b.Invoice_Amount) -(SUM(b.Recovery) + SUM(b.Adjustment)) > \n"
           + "                  = 1 \n"
           + "       )                     x \n"
           + "GROUP BY \n"
           + "       x.CUSTOMERNAME, \n"
