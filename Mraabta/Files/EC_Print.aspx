<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EC_Print.aspx.cs" Inherits="MRaabta.Files.EC_Print" %>
        ...
        <div>
            <div style="width: 700px;">
                <table style="width: 100%; text-align: center; font-family: Calibri; font-size: small;">
                    <tr>
                        ...
                        <td style="width: 60%; text-align: center;">
                            <h2>EXPRESS CENTER INFORMATION</h2>
                        </td>
                ...
                Solid Black; background-color: #C0C0C0">
                    ...
                    <tr>
                        <td colspan="1" style="border-right-style: solid; border-right-width: 1px; border-right-color: #000000; border-bottom-style: solid; border-bottom-width: 2px; border-bottom-color: #000000; border-left-width: 2px; border-left-style: Solid;"
                            class="auto-style1">EC<b> Code: </b>
                            <asp:Label ID="lbl_RiderCode" runat="server"></asp:Label>
                        </td>
                        <td colspan="2" style="border-right-style: solid; border-right-width: 1px; border-right-color: #000000; border-bottom-style: solid; border-bottom-width: 2px; border-bottom-color: #000000; border-left-width: 2px; border-left-style: Solid;"></td>
                        <td colspan="2" style="border-right-style: solid; border-right-width: 2px; border-right-color: #000000; border-bottom-style: solid; border-bottom-width: 2px; border-bottom-color: #000000;">
                            <b>EntryDate: </b>
                    ...
                    <tr>
                        <td colspan="5">
                            <table style="border: thin solid
                #003366; width: 100%; font-family: Calibri; font-size: small; border-collapse: collapse;">
                                <td colspan="6" style="border-right-style: solid; border-right-width: 1px; border-right-color: #000000; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #000000; width: 20%;">
                    ...
                    <tr>
                        <td colspan="5" style="border-right-style: solid; border-right-width: 1px; border-right-color: #000000; border-bottom-style: solid; border-bottom-width: 2px; border-bottom-color: #000000; border-left-width: 2px; border-left-style: Solid;"
                            nowrap>
                            <b>Address: </b>
                    ...
                    <tr>
                        ...
                        <td colspan="1" style="border-right: 1px solid #000000; border-bottom: 2px solid #000000; border-left-width: 2px; border-left-style: Solid;"
                            class="auto-style1"></td>
                        <td colspan="3" style="border-right-style: solid; border-right-width: 1px; border-right-color: #000000; border-bottom-style: solid; border-bottom-width: 2px; border-bottom-color: #000000; border-left-width: 2px; border-left-style: Solid; width: 50%;">
                            <b>EC Type: </b>
