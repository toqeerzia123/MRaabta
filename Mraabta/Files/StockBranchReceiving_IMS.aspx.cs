...
{
    public partial class StockBranchReceiving_IMS : System.Web.UI.Page
    {
        ...
        static String U_ID = ""; static string Locationid = "";
        ...
        public static List<StockModel> GetMyStock()
        {
            ...
            {
                con.Open();
                var rs = con.Query<StockModel>(@"select pr.OracleCode,productID,pr.ProductName,t.TypeName,z.name as Zone, sum(qty) as Qty, FORMAT(sum(qty),N'N0') as Qty_  from (
