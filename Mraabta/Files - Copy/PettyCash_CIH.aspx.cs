...
{
    public partial class PettyCash_CIH : System.Web.UI.Page
    {
        ...
        public void check()
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                double.TryParse(sumObject.ToString(), out petty_amount);
        ...
        public DataSet Get_CashMode(Variable clvar)
        {
            ...
            try
            {
                query = "select * from  PC_cash_mode WHERE id = '2' order by id\n";
        ...
        protected void btn_add_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = new DataTable();
            if (dd_cash_mode.SelectedValue.ToString() == "1")//CIH Amount
            {
                dt = CIH_remainingCash();
                if (dt.Rows.Count > 0)
                {
        ...
        {
            var d = $"{dd_year.SelectedValue.ToString()}/{dd_month.SelectedValue.ToString()}/01";
