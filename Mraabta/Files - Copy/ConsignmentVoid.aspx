<%@ Page Title="" Language="C#" MasterPageFile="~/BtsMasterPage.Master" AutoEventWireup="true" CodeBehind="ConsignmentVoid.aspx.cs" Inherits="MRaabta.Files.ConsignmentVoid" %>
    ...
    <div class="mainTable">
        ...
        <table width="100%">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="dd_remarks" runat="server" AutoPostBack="true" 
                        AppendDataBoundItems="true" 
                        onselectedindexchanged="dd_remarks_SelectedIndexChanged">
                        <asp:ListItem Value="0">Select Remarks</asp:ListItem>
                    </asp:DropDownList>
                    <asp:TextBox ID="txt_Remarks" TextMode="MultiLine" runat="server" Rows="2" Width="100%"
                        Visible="false"></asp:TextBox>
                </td>
                <td align="right">
                    <asp:Button ID="btn_print" runat="server" Text="Void Consignment" Skin="Metro" OnClick="btn_PrintConsignment_Click"
