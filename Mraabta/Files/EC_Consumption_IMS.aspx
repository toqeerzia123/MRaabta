<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="EC_Consumption_IMS.aspx.cs" Inherits="MRaabta.Files.EC_Consumption_IMS" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1" runat="server" class="mt-5">
    ...
    <table cellpadding="0" cellspacing="0" width='100%' class='mGrid_Table'>
        <tr>
            <td colspan="12" align="center" class="head_column">
                <h3 style="text-align: center">Stock Consumption (Express Center)</h3>
            </td>
        </tr>
    </table>
                    ...
                    <td>
                        <nav>
                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link " id="nav-ho-tab" data-toggle="tab" href="#nav-ho" role="tab" aria-controls="nav-ho" aria-selected="false" style="font-size: 14px;">Express Center Consumption</a>
                            </div>
                        </nav>
                    </td>
                </tr>
    ...
    <script type="text/javascript"> 
        ...
        var GetTypeProducts = () => {
            ...
            $.ajax({
                type: "POST",
                url: 'EC_Consumption_IMS.aspx/GetTypeProducts', //
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    TypeProducts = rs.d;
        ...
        var GetFilteredStockZone = (StartDate, EndDate) => {
            $.ajax({
                type: 'post',
                url: 'EC_Consumption_IMS.aspx/GetFilteredStockZone',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var getProductsModal = (Id) => {
            $.ajax({
                type: "POST",
                url: 'EC_Consumption_IMS.aspx/GetProductsSingle',
                contentType: "application/json; charset=utf-8",
        ...
        var getRecordDetails = (Id) => {
            $.ajax({
                type: 'post',
                url: 'StockRequestEC.aspx/GetFilteredStockZonePer',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ Id: Id }),
                success: (rs) => {
        ...
        var ModifyRequest = (data) => {
            $.ajax({
                type: 'post',
                url: 'EC_Consumption_IMS.aspx/ModifyRequest',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var getProducts = () => {
            $.ajax({
                type: "POST",
                url: 'EC_Consumption_IMS.aspx/GetProducts',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    products = rs.d;
        ...
        var save = (data) => {
            $.ajax({
                type: "POST",
                url: 'EC_Consumption_IMS.aspx/SaveStockDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ model: data }),
                success: (rs) => {
        ...
        var GetECConsumption = () => {
            $.ajax({
                type: 'post',
                url: 'EC_Consumption_IMS.aspx/GetECConsumption',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
        ...
        var GetECStock = () => {
            $.ajax({
                type: 'post',
                url: 'EC_Consumption_IMS.aspx/GetECStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getPendingReqDetails = (Id) => {
            $.ajax({
                type: 'post',
                url: 'StockRequestEC.aspx/GetPendingRequestDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ Id: Id }),
                success: (rs) => {
        ...
        var GetPendingRequest = () => {
            $.ajax({
                type: 'post',
                url: 'StockRequestEC.aspx/GetPendingRequest',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var addRow = () => {
            ...
            var html = `<tr>
                            ...
                            <td><input class="form-control txtunit" disabled="disabled" type="text" id="unit" style="width:4em; font-size:12px;"/></td>
