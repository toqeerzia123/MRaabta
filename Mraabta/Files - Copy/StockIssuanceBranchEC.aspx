<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="StockIssuanceBranchEC.aspx.cs" Inherits="MRaabta.Files.StockIssuanceBranchEC" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1" runat="server" class="mt-5">
                        ...
                        <tr>
                            ...
                            <div class="row ml-2 mt-2">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label " style="font-size: 12px;">Express Center</label>
                    ...
                    <table class="MainTbl table table-striped">
                        <thead class="">
                            <tr style="font-size: 12px;">
                                <th style="width: 20%; text-align: center;">Express Center</th>
    ...
    <script>
        ...
        var getZones = () => {
            ...
            $.ajax({
                type: "POST",
                url: 'StockIssuanceBranchEC.aspx/GetExpressCenter',
        ...
        var getRequests = (id) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuanceBranchEC.aspx/GetRequests',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                //async: false,
                //processData: false,
                data: JSON.stringify({ EC: id }),
                success: (rs) => {
        ...
        var getMyStock = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuanceBranchEC.aspx/GetMyStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getZoneStock = (zone) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuanceBranchEC.aspx/GetZoneStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var getRequestDetails = (id, isupdated, zone, name) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuanceBranchEC.aspx/GetRequestsDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var save = (data) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuanceBranchEC.aspx/SaveIssuanceDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
