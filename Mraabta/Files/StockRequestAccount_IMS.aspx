<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="StockRequestAccount_IMS.aspx.cs" Inherits="MRaabta.Files.StockRequestAccount_IMS" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1" runat="server" class="mt-5">
    ...
    <table cellpadding="0" cellspacing="0" width='100%' class='mGrid_Table'>
        <tr>
            <td colspan="12" align="center" class="head_column">
                <h3 style="text-align: center">Stocks Request (Account)</h3>
            </td>
        </tr>
    </table>
    <table>
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group row ml-4  mt-2">
                    ...
                    <label for="ddlRider" class="col-form-label mt-1" style="font-size: 12px;">Account No</label>
                    <%--<select class="ddlRider col-sm-2 form-control ml-1" id="ddlRider" style="font-size: 12px;"></select>--%>
                    <input type="text" name="StartDate" id="ddlRider" class="form-control col-sm-2 ddlRider" style="font-size: 12px;" />
                    ...
                    <td>
                        <nav>
                                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                        <a class="nav-item nav-link active" id="nav-zone-tab" data-toggle="tab" href="#nav-zone" role="tab" aria-controls="nav-zone" aria-selected="false" style="font-size:14px;">Account Stock</a>
    ...
    <script type="text/javascript">
        var getRider = (riderCode) => {
            console.log(riderCode);
            debugger
            $.ajax({

                type: "POST",
                url: 'StockRequestAccount_IMS.aspx/GetAccount',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ AccountNo: riderCode }),
                success: (rs) => {
                    if (rs.d.length > 0) {

                    }
                    else {
                        document.getElementById("ddlRider").value='';
        ...
        $(function () {          
            ...
            $('body').on('change', '#ddlRider', function () {
               ...
               // var id = $(this).val();
                var id = document.getElementById('ddlRider').value;
                GetZoneStock(id);
                getRider(id);
            ...
            $('#btnSave').click(function () {
               ...
               // var riderCode = $(".ddlRider").val();
                var riderCode = document.getElementById("ddlRider").value;
                console.log(riderCode);
                if (riderCode=='') {
        ...
        var GetFilteredStockZone = (StartDate, EndDate) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockRequestAccount_IMS.aspx/GetFilteredStockZone',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var getRecordDetails = (Id, name) => {
            $.ajax({
                type: 'post',
                url: 'StockRequestAccount_IMS.aspx/GetFilteredStockZonePer',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ Id: Id }),
                success: (rs) => {
        ...
        var save = (model) => {
            $.ajax({
                type: "POST",
                url: 'StockRequestAccount_IMS.aspx/SaveStockDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var GetHOStock = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockRequestAccount_IMS.aspx/GetHOStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var GetZoneStock = (zone) => {
            $.ajax({
                type: 'post',
                url: 'StockRequestAccount_IMS.aspx/GetZoneStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
