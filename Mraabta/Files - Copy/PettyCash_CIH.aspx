<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="PettyCash_CIH.aspx.cs" Inherits="MRaabta.Files.PettyCash_CIH" %>
    ...
    <div>
        ...
        <table runat="server" id="tb_1" class="input-form" style="width: 95%;">
            ...
            <tr>
                ...
                <td class="field">
                    <asp:Label ID="lbl1" runat="server" Text="Checque No:" ></asp:Label>
                </td>
                <td class="input-field">
                    <asp:TextBox ID="txt_checque_no" Width="180px" runat="server" onkeypress="return isNumberKeydouble(event);"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td colspan="4">
