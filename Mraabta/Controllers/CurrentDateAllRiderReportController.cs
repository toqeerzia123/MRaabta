...
{
    public class CurrentDateAllRiderReportController : Controller
    {
        CurrentDateAllRiderDB rrd;
        public CurrentDateAllRiderReportController()
        {
            rrd = new CurrentDateAllRiderDB();
        }
        CurrentDateAllRiderDB rrdd = new CurrentDateAllRiderDB();
        LocationDB ldb = new LocationDB();
        RiderDB rdb = new RiderDB();
        // GET: CurrentDateAllRiderReport
        public async Task<ActionResult> Index()
        {
            ...
            //ViewBag.Riders = rs.Select(x => new SelectListItem { Text = All, Value = x.Value }).ToList();
            return View();
        }
