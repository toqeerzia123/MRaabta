<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="StockReceivingEC_IMS.aspx.cs" Inherits="MRaabta.Files.StockReceivingEC_IMS" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1" runat="server" class="mt-5">
    ...
    <script type="text/javascript">
        var getRequests = () => {
            $.ajax({
                type: 'post',
                url: 'StockReceivingEC_IMS.aspx/GetIssuances',
        ...
        var getMyStock = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockReceivingEC_IMS.aspx/GetMyStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getHOStock = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockReceivingEC_IMS.aspx/GetHOStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getReceivedRequest = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockReceivingEC_IMS.aspx/getReceivedRequest',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getReceivedRequestDetails = (id) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockReceivingEC_IMS.aspx/GetIssuancesDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        var getZone = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockReceivingEC_IMS.aspx/GetZone',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var save = (ID) => {
            $.ajax({
                type: 'post',
                url: 'StockReceivingEC_IMS.aspx/SaveReceivedPerIssued',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ ID: ID }),
                success: (rs) => {
