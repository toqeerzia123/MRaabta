<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Scheduler.aspx.cs" Inherits="MRaabta.Files.Scheduler" MasterPageFile="~/BtsMasterPage.Master" %>
   ...
   <%-- <form id="form1" runat="server">--%>
    ...
    <div class="row main-body newPanel">
        <fieldset class="fieldsetSmall">
            ...
            <legend style="font-size: medium;"><b>Scheduler</b></legend>
            ...
            <asp:PostBackTrigger ControlID="btnUpdate" />
                ...
                <ContentTemplate>
                    <div class="btn_div">
                    <asp:Button ID="btnBack" CssClass="btn btn-success" CausesValidation="false" runat="server" OnClick="btnBack_Click" Text="Back" />
                </div>
                        ...
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td style="width: 200px">
                                    <asp:RadioButtonList ID="rdPickupType" Visible="false" RepeatDirection="Horizontal"  runat="server" AutoPostBack="true" OnSelectedIndexChanged="Pickup_Type_SelectedIndexChanged">
                                        <asp:ListItem Value="Cash" Text="Cash"  />
                                        <asp:ListItem Value="Credit" Text="Credit" Selected="True" />
                                    </asp:RadioButtonList>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr id="tdCredit" visible="false" runat="server">
                                ...
                                <td style="width: 140px">
                                    <asp:DropDownList ID="ddlLocation1" Enabled="true" runat="server" OnTextChanged="ddlLocation1_TextChanged" AutoPostBack="true" />
                                     <asp:TextBox  ID="txtlocation"  Visible="false" Style="margin: 10px 18px;" Enabled="false" runat="server" />

                                </td>
                                <td>
                                    <asp:RadioButtonList Visible="false" Enabled="false" ID="rdschedulerPickup"  RepeatDirection="Horizontal" runat="server" 
                                        Style="display: inline-block; margin: 2px 0px 15px;">
                                        <asp:ListItem Text="Yes"  Selected Value="Yes" />
                                        <asp:ListItem Text="No"  Value="No" />
                                    </asp:RadioButtonList>
                                    <asp:Label ID="msg" runat="server"  Visible="false" Enabled="false" ForeColor="Red"></asp:Label>
                                </td>
                                <td>
...
<%--                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator7" Display="Dynamic" runat="server" ControlToValidate="txtLastName" ForeColor="Red" ValidationExpression="^([A-z][A-Za-z]*\s+[A-Za-z]*)|([A-z][A-Za-z]*)$" ErrorMessage="Invalid Name" />--%>
                            ...
                            <tr>
                                ...
                                <td style="width: 140px">
                                        <asp:DropDownList ID="ddlBranchCode" Enabled="false" CssClass="form-control" runat="server">
                            </asp:DropDownList>
                                </td>
                            </tr>
                        </table>
...
InitialValue="-1"  ForeColor="red" style="    display: inline-block;"/>
                            ...
                            <tr>
                                ...
                                <td style="width: 170px">
                                    <asp:TextBox ID="txtWeight" Enabled="true" runat="server" onKeypress="if (event.keyCode < 46 || event.keyCode > 57 || event.keyCode == 47) event.returnValue = false;" MaxLength="2" />
                                    
                                </td>
                                <td style="width: 140px">
                                    <asp:DropDownList ID="ddlWeightTypeID" Enabled="true" runat="server" />
                                </td>
                                <td style="width: 170px">
     ...
     Type="Integer" ErrorMessage="Required" ForeColor="red" style="    display: inline-block;" />
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <table style="width: 100%">
                            ...
                            <tr>
                                <td style="width: 140px">
                                    <asp:RadioButtonList ID="rdScheduled" Enabled="false"  RepeatDirection="Horizontal" runat="server" Style="display: inline-block; margin: 2px 0px 15px;" AutoPostBack="true" OnSelectedIndexChanged="Add_Scheduled_SelectedIndexChanged">
                                        <asp:ListItem Text="Yes" Selected  Value="Yes" />
                                        <asp:ListItem Text="No" Value="No" />
                                    </asp:RadioButtonList>
                                </td>
                            ...
                            <tr>
                                <td style="width: 140px">
                                    <asp:DropDownList ID="ddlRouteCode" Enabled="true" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlRouteCode_SelectedIndexChanged" />
                                      <asp:TextBox  ID="txtRoutCode"  Visible="false" Style="margin: 10px 18px;" Enabled="false" runat="server" />
                                </td>
                                <td style="width: 80px">
