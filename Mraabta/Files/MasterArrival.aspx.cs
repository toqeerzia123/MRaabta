...
{
    public partial class MasterArrival : System.Web.UI.Page
    {
        ...
        public static string[][] InsertArrival(DetailModel[] consignments, MasterModel MasterParameters)
        {
            ...
            new DataColumn("ConsignmentNumber", typeof(string)),
            new DataColumn("OldWeight", typeof(float)),
            ...
            {
                float tempWeight = 0;
                float tempOldWeight = 0;
                int tempPieces = 0;


                float.TryParse(cn.Weight, out tempWeight);
                float.TryParse(cn.OldWeight, out tempOldWeight);
