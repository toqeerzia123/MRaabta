...
{
    public class SelectedRiderReportController : Controller
    {
        SelectedRiderDB rrd;
        public SelectedRiderReportController()
        {
            rrd = new SelectedRiderDB();
        }
        SelectedRiderDB rrdd = new SelectedRiderDB();
        LocationDB ldb = new LocationDB();
        RiderDB rdb = new RiderDB();
        // GET: SelectedRiderReport
