<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="StockBranchReceiving_IMS.aspx.cs" Inherits="MRaabta.Files.StockBranchReceiving_IMS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        var getRequests = () => {
            $.ajax({
                type: 'post',
                url: 'StockBranchReceiving_IMS.aspx/GetIssuances',
        ...
        var getMyStock = () => {
            $.ajax({
                type: 'post',
                url: 'StockBranchReceiving_IMS.aspx/GetMyStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getHOStock = () => {
            $.ajax({
                type: 'post',
                url: 'StockBranchReceiving_IMS.aspx/GetHOStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getReceivedRequestDetails = (id) => {
            $.ajax({
                type: 'post',
                url: 'StockBranchReceiving_IMS.aspx/GetIssuancesDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        var save = (ID) => {
            $.ajax({
                type: 'post',
                url: 'StockBranchReceiving_IMS.aspx/SaveReceivedPerIssued',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ ID: ID }),
                success: (rs) => {
