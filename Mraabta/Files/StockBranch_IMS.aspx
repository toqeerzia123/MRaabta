<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="StockBranch_IMS.aspx.cs" Inherits="MRaabta.Files.StockBranch_IMS" %>
...
<asp:Content ID="form1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript"> 
        ...
        var getLocations = () => {
            $.ajax({
                type: "POST",
                url: 'StockBranch_IMS.aspx/GetLocations',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    Locations = rs.d;
        ...
        var GetFilteredStockZone = (StartDate, EndDate) => {
            $.ajax({
                type: 'post',
                url: 'StockBranch_IMS.aspx/GetFilteredStockZone',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var ModifyRequest = (data) => {
            $.ajax({
                type: 'post',
                url: 'StockBranch_IMS.aspx/ModifyRequest',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var save = (data) => {
            $.ajax({
                type: "POST",
                url: 'StockBranch_IMS.aspx/SaveStockDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ model: data }),
                success: (rs) => {
        ...
        var GetZoneStock = () => {
            $.ajax({
                type: 'post',
                url: 'StockBranch_IMS.aspx/GetZoneStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
