<%@ Page Title="COD Payment" Language="C#" MasterPageFile="~/BtsMasterPage.master" AutoEventWireup="true" CodeBehind="RetailCODPayment.aspx.cs" Inherits="MRaabta.Files.RetailCODPayment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function ShowData() {
            ...
            //            debugger;
            var rb = document.getElementById("<%=codtype.ClientID%>");
            var radio = rb.getElementsByTagName("input");
            var CODType = "";
            for (var i = 0; i < radio.length; i++) {
                if (radio[i].checked) {
                    CODType = radio[i].value;
                    break;
                }
            }
            ...
            $.ajax({
                type: "POST",
                url: "RetailCODPayment.aspx/GetPaymentData",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: "{'zone':'" + Zone.value + "', 'customer':'" + Customer.value + "', 'payable_amount':'" + Condition_amount + "', 'codtype':'" + CODType + "'}",
                beforeSend: function () {
                ...
                success: function (response) {
                    ...
                    for (let y = 0; y < Data.length; y++) {
                        ...
                        if (Data[y].NetPayable < 0) {
                            ...
                            tbody += `<tr>
                                      <td align="center" id="CODPaymentCheck${Data[y].AccountNo}" class="checkboxclass"><input type='checkbox' onclick='getCheckCount()' name='CODPaymentCheck' class='CODPaymentCheck' value='${Data[y].AccountNo}'/></td>`;
                        }
                        tbody += `<td align="center">${serial}</td>
                            ...
                            <td align="center" class='completed' id='Download${Data[y].AccountNo}'></td>
                                </tr >`;
                    }
        ...
        function SaveData() {
            ...
            for (var j = 0; j < checkedValue.length; j++) {
                ...
                $.ajax({
                    type: "POST",
                    url: "RetailCODPayment.aspx/SaveCustomerPaymentData",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    ...
                    success: function (response) {
                        ...
                        cTotal += 1;
                        document.getElementById("payment_complete").innerHTML = "<b>Payment Completed Count:</b> " + cTotal;
        ...
        var fnUpdateCount = function () {
            var generallen = $("#CODPaymentCheck4S508 input[name='CODPaymentCheck']:checked").length;
            debugger;
        ...
        $("#CODPaymentCheck4S508 input:checkbox").on("change", function () {
            fnUpdateCount();
        });
        ...
        function getCheckCount() {
            var rTotal = 0;
            var selectedRealistic = document.getElementsByName('CODPaymentCheck');
            debugger;
            for (var sel = 0; sel < selectedRealistic.length; sel++) {
                if (selectedRealistic[sel].checked)
                    rTotal += selectedRealistic[sel].checked
            }
            document.getElementById("general").innerHTML = "<b>Count:</b> " +rTotal + "/" + selectedRealistic.length + " Checked"
        }


        function getCompletedPaymentCount() {
            var rTotal = 0;
            var selectedRealistic = document.getElementsByName('completed');
            debugger;
            for (var sel = 0; sel < selectedRealistic.length; sel++) {
                if (selectedRealistic[sel].checked)
                    rTotal += selectedRealistic[sel].checked
            }
            document.getElementById("payment_complete").innerHTML = "<b>Payment Completed Count:</b> " + rTotal + "/" + selectedRealistic.length + " Checked"
        }
        ...
        <ContentTemplate>
            <div>
                ...
                <table cellpadding="0" cellspacing="0" style="width: 97% !important;" class="input-form">
                    <tr style="margin: 0;">
                        <td class="input-field" style="width: 12% !important;">
                            <div>COD Type</div>
                            <div>
                                <asp:RadioButtonList ID="codtype" runat="server" CssClass="OperationCriteria" RepeatColumns="1" RepeatLayout="Table"
                                    Width="100%" AutoPostBack="true" OnSelectedIndexChanged="codtype_SelectedIndexChanged">
                                    <asp:ListItem Value="RetailCOD" Text="Retail COD" Selected="True"></asp:ListItem>
                                </asp:RadioButtonList>
                            </div>
                        </td>
                        ...
                        <td class="input-field" style="width: 15% !important; margin: 0 0 0 20px;">
                            <div>Net Amount</div>
                            <div>
                                <asp:TextBox ID="txt_condition_amount" Text="1000" CssClass="txt_condition_amount" runat="server"></asp:TextBox>
                            </div>
                        </td>
                        <td class="input-field" style="width: 13% !important;">
                            ...
                            <div>
                                <asp:RadioButtonList ID="paidstatus" runat="server" CssClass="OperationCriteria" RepeatColumns="1" RepeatLayout="Table"
                ...
                <span id="Table_1" class="tbl-large" style="float: left; width: 100%; position: relative; top: 44%;">
                    ...
                    <div id="general" style="margin: 0 auto;padding: 0 0 0 192px;font-weight: bold;float: left;width: 30%;"></div>
                    <div id="payment_complete" style="float:left;margin: 0;padding: 0 0 0 20px;font-weight: bold;width: 20%;position: relative;left: 300px;"></div>
