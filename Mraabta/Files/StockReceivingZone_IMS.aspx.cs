...
{
    public partial class StockReceivingZone_IMS : System.Web.UI.Page
    {
        ...
        public static List<StockReceivingModel> GetIssuances()
        {
            ...
            {
                con.Open();
                var rs = con.Query<StockReceivingModel>(@"select SI.ID AS IssuanceID,sr.ID RequestID, CONVERT(VARCHAR(11), Sr.CreatedOn, 106) CreatedOn, pr.OracleCode,
sr.TotalReqQty,FORMAT(sr.TotalReqQty,N'N0') as TotalReqQty_ , 
SI.TotalIssueQty,FORMAT(si.TotalIssueQty,N'N0') as TotalIssueQty_
...
inner join MnP_CNIssue_Product pr on pr.id= srd.ProductID
        ...
        public static List<StockModel> GetMyStock()
        {
            ...
            {
                con.Open();
                var rs = con.Query<StockModel>(@"select pr.OracleCode, productID,pr.ProductName,t.TypeName,z.name as Zone, 
                                                sum(qty) as Qty,
