<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchLoadingNew.aspx.cs" Inherits="MRaabta.Files.SearchLoadingNew" MasterPageFile="~/BtsMasterPage.master" %>
    ...
    <div>
        ...
        <table class="input-form" style="width: 90%">
            ...
            <tr>
                ...
                <td class="field" style="width: 10%">Report by Location
                </td>
                <td class="input-field" style="width: 20%;">
            ...
            <asp:GridView ID="GridView" runat="server" AutoGenerateColumns="false" CssClass="mGrid"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-Width="5%" HeaderText="Loading Number" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" CssClass="edit" runat="server" Target="_blank" Text='<%# DataBinder.Eval(Container.DataItem, "id")%>'
                                NavigateUrl='<%# "LoadingPrintNew.aspx?Xcode=" + Eval("id")%>'></asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:BoundField HeaderText="Transport Type" DataField="TransportType" ItemStyle-HorizontalAlign="Center"
                        ItemStyle-Width="10%"></asp:BoundField>
                    <asp:BoundField HeaderText="At Airport" DataField="AtAirport" ItemStyle-HorizontalAlign="Center"
                        ItemStyle-Width="10%"></asp:BoundField>
                    ...
                    <asp:BoundField HeaderText="Total Weight" DataField="TotalWeight" ItemStyle-HorizontalAlign="Center"
                        ItemStyle-Width="10%"></asp:BoundField>
                    <asp:BoundField HeaderText="User Name" DataField="CreatedBy" ItemStyle-HorizontalAlign="Center"
                        ItemStyle-Width="10%"></asp:BoundField>
                </Columns>
            </asp:GridView>
        </span>
