...
{
    public partial class StockRequestEC : System.Web.UI.Page
    {
        ...
        public static List<StockModel> GetECStock()
        {
            ...
            {
                con.Open();
                var rs = con.Query<StockModel>(@"select productID,pr.ProductName ProductName,t.TypeName TypeName,xb.BranchID,xb.ECRiderCode,z.name as Zone, 
        ...
        {
            // return new StockRequestECRepo().GetFilteredStockZonePer(Id);
