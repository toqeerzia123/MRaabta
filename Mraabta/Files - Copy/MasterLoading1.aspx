<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="MasterLoading1.aspx.cs" Inherits="MRaabta.Files.MasterLoading1" %>
    ...
    <body>
        ...
        <div>
            ...
            <div style="width: 100%; height: 300px; overflow: scroll;">
                <Ajax1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="300px"
                    ...
                    <Ajax1:TabPanel ID="TabPanel2" runat="server" HeaderText="Consignments" Height="300px">
                        <ContentTemplate>
                            <table style="width: 100% !important; height: 100% !important;">
                                <tr>
        ...
        <script type="text/javascript">
            ...
            function PopulateBranches() {
                var dropdown = document.getElementById('branches');
                $.ajax({
                    url: 'MasterLoading1.aspx/GetBranchesForDropDown',
                    type: 'POST',
            ...
            function PopulateConTypes() {
                ...
                $.ajax({
                    url: 'MasterLoading1.aspx/GetConTypesForDropDown',
                    type: 'POST',
                    contentType: 'application/json; charset=utf-8',
                    datatype: 'json',
                    data: '',
        ...
        <script type="text/javascript">
            function RouteChange(dd) {
                ...
                $.ajax({
                    url: 'MasterLoading1.aspx/RouteChange',
                    type: 'POST',
                    contentType: 'application/json; charset=utf-8',
                    datatype: 'json',
        ...
        <script type="text/javascript">
            ...
            function AddBag_(Bag) {
                ...
                var saved = false;
                $.ajax({
                    url: 'MasterLoading1.aspx/InsertBag',
                    type: 'POST',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    ...
                    success: function (result) {
                        ...
                        if (resp.Status.toString() == "0") {
                            ...
                            window.location.href = "MasterLoading1.aspx";
                            txt_bagno.disabled = false;
                            return;
                        }
                        else {
            ...
            function AddBagEdit(SingleBag, AddMode) {
                ...
                getColor(newTr.cells[4].childNodes[0]);
                col = newTr.insertCell(5);
                newTr.cells[5].appendChild(txtseal);
        ...
        <script type="text/javascript">
            ...
            var getColor = (el) => {
                ...
                //el.parentElement.childNodes[0].css('backgroundColor', 'red');
                    $.ajax({
                        type: 'POST',
                        url: 'MasterLoading1.aspx/GetData',
            ...
            function AddConsignment() {
                ...
                var saved = false;
                $.ajax({
                    url: 'MasterLoading1.aspx/InsertConsignment',
                    type: 'POST',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    data: JSON.stringify(JsonObj),
        ...
        <script type="text/javascript">
            function RemoveRow(btn) {
                ...
                if (LoadingID.trim() != "") {
                    ...
                    $.ajax({
                        url: 'MasterLoading1.aspx/RemoveRow',
                        type: 'POST',
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'json',
        ...
        <script type="text/javascript">
            function SaveLoading() {
                ...
                $.ajax({
                    ...
                    url: 'MasterLoading1.aspx/InsertLoading',
                    type: 'POST',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    data: JSON.stringify(jsonObj),
                    success: function (resp_) {
                        ...
                        if (resp[0] == "1") {
                            ...
                            ResetAll();
                            window.open('MasterLoading1.aspx', '_self');
                        }
                        else {
        ...
        <script type="text/javascript">
            function VidChange(txt) {
                ...
                $.ajax({
                    url: 'MasterLoading1.aspx/GetLoadingData',
                    type: 'POST',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
                    data: "{'vid':'" + vid + "'}",
