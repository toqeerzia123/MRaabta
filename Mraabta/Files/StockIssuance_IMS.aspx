<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="StockIssuance_IMS.aspx.cs" Inherits="MRaabta.Files.StockIssuance_IMS" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1" runat="server" class="mt-5">
            ...
            <div class="shadow rounded">
                <div class="">
                    ...
                    <div class="row ml-2 mt-2">
                        <div class="col-md-5">
                            <div class="form-group">
                                <label for="inputEmail3" class=" col-form-label mt-1" style="font-size: 12px;">Zone</label>
                    ...
                    <table class="MainTbl table table-striped">
                        <thead class="">
                            <tr style="font-size: 12px;">
                                ...
                                <th style="width: 10%; text-align: center;">Oracle Code</th>
                                <th style="width: 10%; text-align: center;">Req #</th>
                                <th style="width: 15%; text-align: center;">Req Date</th>
                                <th style="width: 20%; text-align: center;">Total Req Qty</th>
    ...
    <script type="text/javascript">
        ...
        var getZones = () => {
            ...
            $.ajax({
                type: "POST",
                url: 'StockIssuance_IMS.aspx/GetZones',
        ...
        var getRequests = (id, startdate, enddate) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuance_IMS.aspx/GetRequests',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false, 
            ...
            swal({
                ...
                closeOnConfirm: true
                    ...
                    if (isConfirm == true) {
                        $.ajax({
                            type: "POST",
                            url: 'StockIssuance_IMS.aspx/DeleteStockRequest',
                            contentType: "application/json; charset=utf-8",
        ...
        var getMyStock = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuance_IMS.aspx/GetMyStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getZoneStock = (zone) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuance_IMS.aspx/GetZoneStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var getRequestDetails = (id, isupdated, zone, name) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockIssuance_IMS.aspx/GetRequestsDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        var save = (data) => { 
            $.ajax({
                type: 'post',
                url: 'StockIssuance_IMS.aspx/SaveIssuanceDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        $(function () {
            ...
            $('body').on('blur', '.txtissueqty', function () {
                ...
                if (issueqty > qty) {
                    ...
                    $('#error-msg').html("Your Entered Quantity is greater than requested quantity");
                    $(this).focus();
                    return;
                }
                if (qtyIssueFrom == 0) { 
            ...
            $('body').on('click', '#btnSubmit', function () {
                ...
                if (FOC != "" && FOC != null && FOC != "invalid") {
                    ...
                    for (let x of rows) {
                        ...
                        var requestedQty = parseInt(row.find('td:eq(4)')[0].innerText.replace(/,/g, ''));
