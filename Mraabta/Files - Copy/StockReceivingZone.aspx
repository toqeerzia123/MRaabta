<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="StockReceivingZone.aspx.cs" Inherits="MRaabta.Files.StockReceivingZone" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1" runat="Server">
    ...
    <script type="text/javascript">
        var getRequests = () => {
            $.ajax({
                type: 'post',
                url: 'StockReceivingZone.aspx/GetIssuances',
        ...
        var getMyStock = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockReceivingZone.aspx/GetMyStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getHOStock = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockReceivingZone.aspx/GetHOStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getReceivedRequest = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockReceivingZone.aspx/getReceivedRequest',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getReceivedRequestDetails = (id) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockReceivingZone.aspx/GetIssuancesDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        var getZone = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockReceivingZone.aspx/GetZone',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var ReceivePerIssued = (ID) => {
            $.ajax({
                type: 'post',
                url: 'StockReceivingZone.aspx/SaveReceivedPerIssued',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ ID: ID }),
                success: (rs) => {
        ...
        $(function () {
            ...
            $('body').on('click', '.BtnReceive', function () {
                ...
                //var dd = document.getElementById('BtnReceive').val();
