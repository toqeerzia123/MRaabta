<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BtsMasterPage.Master" CodeBehind="StockReceivingZone_IMS.aspx.cs" Inherits="MRaabta.Files.StockReceivingZone_IMS" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="Content1" runat="Server">
            ...
            <table cellpadding="0" cellspacing="0" width='100%' class='mGrid_Table'>
                <tr>
                    <td colspan="12" align="center" class="head_column">
                        <h3 style="text-align: center">Stocks Recieved (Zone)
                ...
                <table class="MainTbl table table-striped">
                        <thead class="">
                            <tr style="font-size: 12px;">
                                ...
                                <th>Req Date Req</th>
                                <th>Oracle Code</th>
                                <th style="width: 25%">Total Req Qty</th>
                                <th style="width: 25%">Total Issued Qty</th>
                                <th></th>
                            </tr>
                        </thead>
        ...
        <div class="col-md-6">
                    ...
                    <td>
                        <nav>
                                    <div class="nav nav-tabs nav-fill " id="nav-tab" role="tablist">
                                        ...
                                        <a class="nav-item nav-link " id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="false">Head Office Stock</a>
                                        <%--<a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Recieved Requests</a>--%>
                                    <%--    <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Issued Request</a>--%>
                                    </div>
                            </nav>
                    </td>
                </tr>
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <%--                                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                ...
                                <table class="MainTbl table table-striped mt-4">
                                    <thead>
                                        <tr>
                                          <th>Zone </th>
    ...
    <script type="text/javascript">
        var getRequests = () => {
            $.ajax({
                type: 'post',
                url: 'StockReceivingZone_IMS.aspx/GetIssuances',
        ...
        var getMyStock = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockReceivingZone_IMS.aspx/GetMyStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getHOStock = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockReceivingZone_IMS.aspx/GetHOStock',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getReceivedRequest = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockReceivingZone_IMS.aspx/getReceivedRequest',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var getReceivedRequestDetails = (id) => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockReceivingZone_IMS.aspx/GetIssuancesDetails',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
        ...
        var getZone = () => {
            ...
            $.ajax({
                type: 'post',
                url: 'StockReceivingZone_IMS.aspx/GetZone',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: (rs) => {
                    var data = rs.d;
        ...
        var ReceivePerIssued = (ID) => {
            $.ajax({
                type: 'post',
                url: 'StockReceivingZone_IMS.aspx/SaveReceivedPerIssued',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: JSON.stringify({ ID: ID }),
                success: (rs) => {
